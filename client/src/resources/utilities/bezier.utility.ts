...
export class BezierUtility {
	...
	private static NEWTON_ITERATIONS = 4;
	private static NEWTON_MIN_SLOPE = 0.001;
	private static SUBDIVISION_PRECISION = 0.0000001;
	private static SUBDIVISION_MAX_ITERATIONS = 10;
	private static kSplineTableSize = 11;
	private static kSampleStepSize = 1.0 / (BezierUtility.kSplineTableSize - 1.0);
