...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			set_style(container0, "--outer-filter", "blur(" + (/*$scaleW*/ ctx[3] - 1) + "px)");
			add_location(container0, file$2, 81, 1, 2629);
			attr_dev(container1, "class", "outer blinker svelte-15ys7dv");
			toggle_class(container1, "paused", /*isBlinkerPaused*/ ctx[6]);
			add_location(container1, file$2, 89, 1, 2791);
			set_style(component_1, "--colour-background", CSSUtility.parse(/*backgroundColour*/ ctx[0]));
			attr_dev(component_1, "class", "svelte-15ys7dv");
			add_location(component_1, file$2, 72, 0, 2428);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*isBlinkerPaused*/ 64) {
				toggle_class(container1, "paused", /*isBlinkerPaused*/ ctx[6]);
			}

			const button_changes = {};
			if (dirty & /*buttonColour*/ 2) button_changes.backgroundColour = /*buttonColour*/ ctx[1];
			if (dirty & /*hoverColour*/ 4) button_changes.hoverColour = /*hoverColour*/ ctx[2];
...
function instance$2($$self, $$props, $$invalidate) {
	...
	const writable_props = ["backgroundColour", "buttonColour", "hoverColour"];
	...
	$$self.$$set = $$props => {
		...
		if ("hoverColour" in $$props) $$invalidate(2, hoverColour = $$props.hoverColour);
	};
	...
	$$self.$inject_state = $$props => {
		...
		if ("outer" in $$props) $$invalidate(5, outer = $$props.outer);
		if ("isHolding" in $$props) isHolding = $$props.isHolding;
		if ("animation" in $$props) animation = $$props.animation;
		if ("isBlinkerPaused" in $$props) $$invalidate(6, isBlinkerPaused = $$props.isBlinkerPaused);
	};
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*$scaleW*/ 8) {
			$: $scaleW === 1
			? $$invalidate(6, isBlinkerPaused = false)
			: $$invalidate(6, isBlinkerPaused = true);
		}
	};
...
//# sourceMappingURL=CallRoute-c41097dc.js.map
