...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(heading, file$1, 45, 4, 1175);
		},
		m: function mount(target, anchor) {
...
// (20:0) <Fragment   isPadded={true}   isInAnimated={true}   isOutAnimated={true}   padding='18px'   height='100vh'   width='100%'   justify='flex-start'   rows={`repeat(${    // + logo    IconAndTitleEntries.length + 1   }, 56px)`}  >
function create_default_slot$1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(20:0) <Fragment   isPadded={true}   isInAnimated={true}   isOutAnimated={true}   padding='18px'   height='100vh'   width='100%'   justify='flex-start'   rows={`repeat(${    // + logo    IconAndTitleEntries.length + 1   }, 56px)`}  >",
		ctx
	});
...
//# sourceMappingURL=DashboardRoute-7480cf67.js.map
