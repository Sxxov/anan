...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container, file$2, 87, 1, 2771);
			attr_dev(component_1, "class", "svelte-e1nm");
			add_location(component_1, file$2, 80, 0, 2621);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=CallRoute-21e9f2b6.js.map
