...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(heading, file$1, 34, 4, 963);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(34:3) {#if $isTitlesEnabledW}",
		ctx
	});
...
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(31:2) <FillOrStrokeButton     {icon}    >",
		ctx
	});
...
// (30:1) {#each IconAndTitleEntries as [icon, title]}
function create_each_block(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(30:1) {#each IconAndTitleEntries as [icon, title]}",
		ctx
	});
...
// (20:0) <Fragment   isPadded={false}   isInAnimated={true}   isOutAnimated={true}   height='100vh'   width='100%'   justify='flex-start'   rows={`repeat(${IconAndTitleEntries.length}, 56px)`}  >
function create_default_slot$1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(20:0) <Fragment   isPadded={false}   isInAnimated={true}   isOutAnimated={true}   height='100vh'   width='100%'   justify='flex-start'   rows={`repeat(${IconAndTitleEntries.length}, 56px)`}  >",
		ctx
	});
...
function create_fragment$1(ctx) {
	...
	fragment = new Fragment({
			props: {
				...
				width: "100%",
				justify: "flex-start",
				rows: `repeat(${/*IconAndTitleEntries*/ ctx[2].length}, 56px)`,
...
//# sourceMappingURL=DashboardRoute-65e08206.js.map
