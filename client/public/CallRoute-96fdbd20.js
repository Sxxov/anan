...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container0, file$4, 134, 3, 4459);
			...
			add_location(container1, file$4, 126, 2, 4238);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(126:1) {#if isArrowEnabled}",
		ctx
	});
...
function create_fragment$4(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(component_1, file$4, 106, 0, 3749);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$4($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty & /*$isThresholdCrossedW*/ 2097152) {
			$: console.log($isThresholdCrossedW);
		}
	};
...
//# sourceMappingURL=CallRoute-96fdbd20.js.map
