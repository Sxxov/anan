...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container, file$2, 90, 1, 2780);
			attr_dev(component_1, "class", "svelte-15wlqew");
			add_location(component_1, file$2, 84, 0, 2655);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=CallRoute-83752ae7.js.map
