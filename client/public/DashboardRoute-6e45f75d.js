...
function create_default_slot_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(string, "class", "svelte-lr5w0t");
...
function create_default_slot$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container0, "class", "frame svelte-lr5w0t");
			add_location(container0, file$1, 30, 3, 9663);
			attr_dev(container1, "class", "pp svelte-lr5w0t");
...
//# sourceMappingURL=DashboardRoute-6e45f75d.js.map
