...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container, "class", "outer svelte-1ty4xa");
			set_style(container, "--transform", "scale(" + /*$scaleW*/ ctx[3] + ")");
			set_style(container, "--colour-background", /*backgroundColour*/ ctx[0]);
			add_location(container, file$2, 65, 1, 2191);
			attr_dev(component_1, "class", "svelte-1ty4xa");
			add_location(component_1, file$2, 51, 0, 1897);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		m: function mount(target, anchor) {
			...
			/*component_1_binding*/ ctx[10](component_1);
			current = true;
		...
		d: function destroy(detaching) {
			...
			/*component_1_binding*/ ctx[10](null);
			mounted = false;
			run_all(dispose);
		}
	};
...
function instance$2($$self, $$props, $$invalidate) {
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<ExpandingButton> was created with unknown prop '${key}'`);
	});
...
//# sourceMappingURL=CallRoute-7635d2c1.js.map
