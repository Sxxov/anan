...
// (24:0) <Button   on:click={() => dispatch('click')}   on:mouseover={() => dispatch('mouseover')}   on:mousein={() => dispatch('mousein')}   on:mouseout={() => dispatch('mouseout')}   {...$$restProps}  >
function create_default_slot$2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(24:0) <Button   on:click={() => dispatch('click')}   on:mouseover={() => dispatch('mouseover')}   on:mousein={() => dispatch('mousein')}   on:mouseout={() => dispatch('mouseout')}   {...$$restProps}  >",
		ctx
	});
...
function create_icon_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(placeholder_1, file$2, 30, 1, 1044);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = text(t_value);
			attr_dev(heading, "class", "svelte-1vjlst7");
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = space();
			attr_dev(container, "class", "button svelte-1vjlst7");
...
//# sourceMappingURL=DashboardRoute-2f41c1bf.js.map
