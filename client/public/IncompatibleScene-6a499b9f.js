...
import { S as Spacer, e as element, s as space, c as create_component, t as text, a as attr_dev, b as add_location, i as insert_dev, d as append_dev, m as mount_component, n as noop, f as transition_in, g as transition_out, h as detach_dev, j as destroy_component, k as dispatch_dev, l as Scene, v as validate_slots, C as Ctx, r as replace, o as SvelteComponentDev, p as init, q as safe_not_equal } from './index-94273147.js';
import 'common/src/resources/errors';

var undefined$1 = undefined;

/* src\ui\routes\errors\IncompatibleScene.svelte generated by Svelte v3.38.2 */
const file = "src\\ui\\routes\\errors\\IncompatibleScene.svelte";
...
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(heading, "class", "svelte-1lmi56u");
			add_location(heading, file, 19, 2, 426);
			attr_dev(a, "href", "https://chrome.google.com");
			add_location(a, file, 24, 17, 540);
			attr_dev(string0, "class", "svelte-1lmi56u");
			add_location(string0, file, 23, 2, 513);
			attr_dev(string1, "class", "svelte-1lmi56u");
			add_location(string1, file, 27, 2, 640);
			attr_dev(container, "class", "content");
			add_location(container, file, 16, 1, 389);
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	validate_slots("IncompatibleScene", slots, []);
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<IncompatibleScene> was created with unknown prop '${key}'`);
	});

	$$self.$capture_state = () => ({ replace, Ctx, Scene, Spacer, context });
	return [context];
}

class IncompatibleScene extends SvelteComponentDev {
	constructor(options) {
		super(options);
...
export default IncompatibleScene;
//# sourceMappingURL=IncompatibleScene-6a499b9f.js.map
