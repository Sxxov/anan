...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container, "class", "outer arrow svelte-1ncbd5");
			set_style(container, "--arrow-transform", "rotate(" + /*arrowRotationDeg*/ ctx[11] + "deg) scale(" + /*$scaleW*/ ctx[6] + ")");
			set_style(container, "--arrow-filter", "blur(" + (/*$scaleW*/ ctx[6] - 2) + "px)");
			add_location(container, file$2, 113, 2, 3686);
		},
		m: function mount(target, anchor) {
			insert_dev(target, container, anchor);
			/*container_binding*/ ctx[22](container);
		},
		p: function update(ctx, dirty) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t2 = space();
			create_component(button.$$.fragment);
			attr_dev(container0, "class", "outer touch svelte-1ncbd5");
			...
			attr_dev(container1, "class", "outer blinker svelte-1ncbd5");
			toggle_class(container1, "paused", !/*isBlinkerActive*/ ctx[10]);
			add_location(container1, file$2, 122, 1, 3893);
			...
			attr_dev(component_1, "class", "svelte-1ncbd5");
...
//# sourceMappingURL=CallRoute-c6a0ad9d.js.map
