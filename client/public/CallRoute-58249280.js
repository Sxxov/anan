...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container0, file$2, 125, 3, 4134);
			...
			add_location(container1, file$2, 117, 2, 3913);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(117:1) {#if isArrowEnabled}",
		ctx
	});
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(component_1, file$2, 97, 0, 3424);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$2($$self, $$props, $$invalidate) {
	...
	function onMouseUp() {
		...
		animation = outer.animate([{ transform: "scale(1)" }], options);

		arrow === null || arrow === void 0
		? void 0
		: arrow.animate([{ transform: "rotate(0) scale(1)" }], options);
...
//# sourceMappingURL=CallRoute-58249280.js.map
