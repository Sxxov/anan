...
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			heading = element("heading");
			heading.textContent = "stay safe.";
			t2 = space();
			create_component(tweet.$$.fragment);
			attr_dev(container0, "class", "sidebar svelte-1eyd7f5");
			add_location(container0, file, 14, 2, 329);
			add_location(heading, file, 25, 4, 479);
			attr_dev(component0, "class", "header svelte-1eyd7f5");
			add_location(component0, file, 22, 3, 437);
			attr_dev(container1, "class", "main svelte-1eyd7f5");
			add_location(container1, file, 19, 2, 400);
			attr_dev(component1, "class", "svelte-1eyd7f5");
...
//# sourceMappingURL=DashboardRoute-8d952c32.js.map
