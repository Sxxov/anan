...
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container, "class", "sidebar svelte-pwpigm");
			add_location(container, file, 13, 2, 280);
			attr_dev(component, "class", "svelte-pwpigm");
...
//# sourceMappingURL=DashboardRoute-345ea810.js.map
