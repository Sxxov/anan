...
function create_default_slot_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(string, "class", "svelte-1mhx4s8");
			add_location(string, file$1, 88, 5, 10852);
		},
		m: function mount(target, anchor) {
...
function create_default_slot_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			string.textContent = `${RandomUtility.int(2)}`;
			attr_dev(string, "class", "svelte-1mhx4s8");
			add_location(string, file$1, 108, 5, 11473);
		},
		m: function mount(target, anchor) {
			insert_dev(target, string, anchor);
		},
...
function create_default_slot_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(string, "class", "svelte-1mhx4s8");
			add_location(string, file$1, 127, 5, 11993);
		},
		m: function mount(target, anchor) {
			insert_dev(target, string, anchor);
		},
...
function create_default_slot$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container5, "class", "retweet svelte-1mhx4s8");
			set_style(container5, "--colour-fill-hover-primary", "#17bf63");
			set_style(container5, "--colour-fill-hover-secondary", "#17bf6333");
			add_location(container5, file$1, 93, 3, 10956);
			attr_dev(container6, "class", "like svelte-1mhx4s8");
			...
			add_location(container6, file$1, 113, 3, 11577);
			attr_dev(container7, "class", "actions svelte-1mhx4s8");
			add_location(container7, file$1, 70, 2, 10297);
			attr_dev(component, "class", "svelte-1mhx4s8");
...
//# sourceMappingURL=DashboardRoute-3ebedc75.js.map
