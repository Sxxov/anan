...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(heading, file$1, 44, 4, 1159);
		},
		m: function mount(target, anchor) {
...
// (38:2) <FillOrStrokeButton     backgroundColour='transparent'     hoverColour='--colour-accent-secondary'     on:hover={() => {}}     {icon}    >
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(38:2) <FillOrStrokeButton     backgroundColour='transparent'     hoverColour='--colour-accent-secondary'     on:hover={() => {}}     {icon}    >",
		ctx
	});
...
//# sourceMappingURL=DashboardRoute-b9db108f.js.map
