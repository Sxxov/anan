...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(heading, file$1, 37, 4, 987);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(37:3) {#if $isTitlesEnabledW}",
		ctx
	});
...
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(34:2) <FillOrStrokeButton     {icon}    >",
		ctx
	});
...
// (33:1) {#each IconAndTitleEntries as [icon, title]}
function create_each_block(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(33:1) {#each IconAndTitleEntries as [icon, title]}",
		ctx
	});
...
//# sourceMappingURL=DashboardRoute-1472978a.js.map
