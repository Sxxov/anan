...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			set_style(container0, "--outer-filter", "blur(" + /*$scaleW*/ ctx[2] * 2 + "px)");
			...
			add_location(container1, file$2, 88, 1, 2740);
...
//# sourceMappingURL=CallRoute-0b35408c.js.map
