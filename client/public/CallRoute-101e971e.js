...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = space();
			create_component(button.$$.fragment);
			attr_dev(container, "class", "outer svelte-15wlqew");
			set_style(container, "--outer-transform", "scale(" + /*$scaleW*/ ctx[4] + ")");
			set_style(container, "--colour-background", CSSUtility.parse(/*backgroundColour*/ ctx[0]));
			add_location(container, file$2, 87, 1, 2736);
			attr_dev(component_1, "class", "svelte-15wlqew");
			add_location(component_1, file$2, 80, 0, 2586);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		m: function mount(target, anchor) {
			...
			/*container_binding*/ ctx[10](container);
			...
			if (!mounted) {
				dispose = [
					listen_dev(window, "mousemove", /*onMouseMove*/ ctx[9], false, false, false),
					listen_dev(window, "touchmove", /*onMouseMove*/ ctx[9], false, false, false),
					listen_dev(component_1, "touchstart", /*onMouseDown*/ ctx[7], { passive: true }, false, false),
					listen_dev(component_1, "mousedown", /*onMouseDown*/ ctx[7], false, false, false),
					listen_dev(component_1, "touchend", /*onMouseUp*/ ctx[8], { passive: true }, false, false),
					listen_dev(component_1, "mouseup", /*onMouseUp*/ ctx[8], false, false, false)
				];
...
function instance$2($$self, $$props, $$invalidate) {
	...
	function onMouseUp() {
		...
		animation = component.animate([{ transform: `scale(${$scaleW})` }, { transform: "scale(1)" }], {
			duration: 500,
			easing: CSSUtility.getVariable("--ease-fast-slow")
		});
	...
	$$self.$inject_state = $$props => {
		...
		if ("outer" in $$props) $$invalidate(3, outer = $$props.outer);
...
//# sourceMappingURL=CallRoute-101e971e.js.map
