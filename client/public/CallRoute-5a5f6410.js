...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container0, "class", "outer arrow content svelte-obbq0t");
			add_location(container0, file$2, 121, 3, 3894);
			attr_dev(container1, "class", "outer arrow wrapper svelte-obbq0t");
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t2 = space();
			create_component(button.$$.fragment);
			attr_dev(container0, "class", "outer touch svelte-obbq0t");
			...
			attr_dev(container1, "class", "outer blinker svelte-obbq0t");
			...
			attr_dev(component_1, "class", "svelte-obbq0t");
...
//# sourceMappingURL=CallRoute-5a5f6410.js.map
