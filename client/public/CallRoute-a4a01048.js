...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			set_style(container, "--outer-transform", "scale(" + /*$scaleW*/ ctx[3] + ")");
			set_style(container, "--colour-background", /*backgroundColour*/ ctx[0]);
			add_location(container, file$2, 86, 1, 2724);
			attr_dev(component_1, "class", "svelte-15wlqew");
			add_location(component_1, file$2, 79, 0, 2574);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=CallRoute-a4a01048.js.map
