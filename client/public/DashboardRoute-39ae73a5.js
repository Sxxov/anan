...
// (48:3) <FillOrTwoToneButton      backgroundColour='transparent'      hoverColour='--colour-accent-secondary'      {icon}      isTwoTone={i !== activeIndex}      fillColour={i === activeIndex ? '--colour-accent-primary' : '--colour-text-secondary'}      iconSize='1.4rem'     >
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(48:3) <FillOrTwoToneButton      backgroundColour='transparent'      hoverColour='--colour-accent-secondary'      {icon}      isTwoTone={i !== activeIndex}      fillColour={i === activeIndex ? '--colour-accent-primary' : '--colour-text-secondary'}      iconSize='1.4rem'     >",
		ctx
	});
...
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container, "class", "sidebar svelte-wpmj6v");
			add_location(container, file, 13, 2, 280);
			attr_dev(component, "class", "svelte-wpmj6v");
...
//# sourceMappingURL=DashboardRoute-39ae73a5.js.map
