...
function create_default_slot_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(string, "class", "svelte-eptfi7");
			add_location(string, file$1, 89, 5, 10840);
		},
		m: function mount(target, anchor) {
...
function create_default_slot_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			string.textContent = `${RandomUtility.int(2)}`;
			attr_dev(string, "class", "svelte-eptfi7");
			add_location(string, file$1, 109, 5, 11459);
		},
		m: function mount(target, anchor) {
			insert_dev(target, string, anchor);
		},
...
function create_default_slot_1$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(string, "class", "svelte-eptfi7");
			add_location(string, file$1, 128, 5, 11979);
		},
		m: function mount(target, anchor) {
			insert_dev(target, string, anchor);
		},
...
function create_default_slot$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(heading, "class", "svelte-eptfi7");
			add_location(heading, file$1, 32, 4, 9651);
			attr_dev(container0, "class", "frame svelte-eptfi7");
			add_location(container0, file$1, 29, 3, 9610);
			attr_dev(container1, "class", "pp svelte-eptfi7");
			add_location(container1, file$1, 26, 2, 9575);
			attr_dev(a, "href", a_href_value = "javascript:void(0)");
			attr_dev(a, "class", "svelte-eptfi7");
			add_location(a, file$1, 42, 5, 9804);
			add_location(b, file$1, 41, 4, 9794);
			attr_dev(string0, "class", "svelte-eptfi7");
			add_location(string0, file$1, 40, 3, 9780);
			attr_dev(container2, "class", "meta svelte-eptfi7");
			add_location(container2, file$1, 37, 2, 9743);
			attr_dev(string1, "class", "svelte-eptfi7");
			add_location(string1, file$1, 57, 3, 10074);
			attr_dev(container3, "class", "content svelte-eptfi7");
			add_location(container3, file$1, 54, 2, 10034);
			attr_dev(container4, "class", "reply svelte-eptfi7");
			set_style(container4, "--colour-fill-hover-primary", "#1da1f2");
			set_style(container4, "--colour-fill-hover-secondary", "#1da1f233");
			add_location(container4, file$1, 74, 3, 10325);
			attr_dev(container5, "class", "retweet svelte-eptfi7");
			set_style(container5, "--colour-fill-hover-primary", "#17bf63");
			set_style(container5, "--colour-fill-hover-secondary", "#17bf6333");
			add_location(container5, file$1, 94, 3, 10944);
			attr_dev(container6, "class", "like svelte-eptfi7");
			...
			add_location(container6, file$1, 114, 3, 11563);
			attr_dev(container7, "class", "report svelte-eptfi7");
			...
			add_location(container7, file$1, 133, 3, 12083);
			attr_dev(container8, "class", "actions svelte-eptfi7");
			add_location(container8, file$1, 71, 2, 10285);
			attr_dev(component, "class", "svelte-eptfi7");
			add_location(component, file$1, 25, 1, 9560);
		},
		m: function mount(target, anchor) {
...
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			component1 = element("component");
			container0 = element("container");
			create_component(sidebar.$$.fragment);
			t0 = space();
			container1 = element("container");
			component0 = element("component");
			heading = element("heading");
			heading.textContent = "Home";
			t2 = space();
			create_component(tweet.$$.fragment);
			attr_dev(container0, "class", "sidebar svelte-ii6js6");
			add_location(container0, file, 14, 2, 329);
			attr_dev(heading, "class", "svelte-ii6js6");
			add_location(heading, file, 25, 4, 479);
			attr_dev(component0, "class", "header svelte-ii6js6");
			add_location(component0, file, 22, 3, 437);
			attr_dev(container1, "class", "main svelte-ii6js6");
			add_location(container1, file, 19, 2, 400);
			attr_dev(component1, "class", "svelte-ii6js6");
			add_location(component1, file, 13, 1, 314);
		},
		m: function mount(target, anchor) {
			insert_dev(target, component1, anchor);
			append_dev(component1, container0);
			mount_component(sidebar, container0, null);
			append_dev(component1, t0);
			append_dev(component1, container1);
			append_dev(container1, component0);
			append_dev(component0, heading);
		...
		d: function destroy(detaching) {
			if (detaching) detach_dev(component1);
...
//# sourceMappingURL=DashboardRoute-877fb792.js.map
