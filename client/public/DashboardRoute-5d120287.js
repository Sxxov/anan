...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			iconf = element("iconf");
			t = text(/*$iconW*/ ctx[7]);
			set_style(iconf, "--colour-fill", CSSUtility.parse(/*currentFillColour*/ ctx[4]));
			attr_dev(iconf, "class", "svelte-1da5x49");
			add_location(iconf, file$2, 47, 3, 1484);
		},
		...
		p: function update(ctx, dirty) {
			if (dirty & /*$iconW*/ 128) set_data_dev(t, /*$iconW*/ ctx[7]);

			if (dirty & /*currentFillColour*/ 16) {
				set_style(iconf, "--colour-fill", CSSUtility.parse(/*currentFillColour*/ ctx[4]));
			}
		},
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			icon_1 = element("icon");
			t = text(/*$iconW*/ ctx[7]);
			set_style(icon_1, "--filter-twotone", CSSUtility.parse(/*currentTwoToneFilter*/ ctx[5]));
			attr_dev(icon_1, "class", "svelte-1da5x49");
			add_location(icon_1, file$2, 39, 3, 1345);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, dirty) {
			...
			if (dirty & /*currentTwoToneFilter*/ 32) {
				set_style(icon_1, "--filter-twotone", CSSUtility.parse(/*currentTwoToneFilter*/ ctx[5]));
			}
		},
		d: function destroy(detaching) {
...
// (30:0) <Button   on:click={() => dispatch('click')}   on:mouseover={() => ((isHovering = true), dispatch('mouseover'))}   on:mouseout={() => ((isHovering = false),  dispatch('mouseout'))}   hoverColour={backgroundHoverColour}   {...$$restProps}   isText={false}  >
function create_default_slot$2(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*$isTwoToneW*/ ctx[6]) return create_if_block$1;
	...
	const block = {
		c: function create() {
			...
			attr_dev(container, "class", "svelte-1da5x49");
			add_location(container, file$2, 37, 1, 1307);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(30:0) <Button   on:click={() => dispatch('click')}   on:mouseover={() => ((isHovering = true), dispatch('mouseover'))}   on:mouseout={() => ((isHovering = false),  dispatch('mouseout'))}   hoverColour={backgroundHoverColour}   {...$$restProps}   isText={false}  >",
		ctx
	});
...
function create_fragment$2(ctx) {
	...
	const button_spread_levels = [
		{
			hoverColour: /*backgroundHoverColour*/ ctx[2]
		},
		/*$$restProps*/ ctx[9],
		{ isText: false }
	];
	...
	button.$on("mouseover", /*mouseover_handler*/ ctx[18]);
	button.$on("mouseout", /*mouseout_handler*/ ctx[19]);
	...
	const block = {
		...
		p: function update(ctx, [dirty]) {
			const button_changes = (dirty & /*backgroundHoverColour, $$restProps*/ 516)
			? get_spread_update(button_spread_levels, [
					dirty & /*backgroundHoverColour*/ 4 && {
						hoverColour: /*backgroundHoverColour*/ ctx[2]
					},
			...
			if (dirty & /*$$scope, currentTwoToneFilter, $iconW, $isTwoToneW, currentFillColour*/ 1048816) {
...
function instance$2($$self, $$props, $$invalidate) {
	const omit_props_names = [
		"isTwoTone","isTwoToneW","icon","iconW","twoToneFilter","fillColour","hoverFillColour","hoverTwoToneFiler","backgroundHoverColour"
	];
	...
	let $isTwoToneW,
		...
		$$subscribe_isTwoToneW = () => ($$unsubscribe_isTwoToneW(), $$unsubscribe_isTwoToneW = subscribe(isTwoToneW, $$value => $$invalidate(6, $isTwoToneW = $$value)), isTwoToneW);

	let $iconW,
		$$unsubscribe_iconW = noop,
		$$subscribe_iconW = () => ($$unsubscribe_iconW(), $$unsubscribe_iconW = subscribe(iconW, $$value => $$invalidate(7, $iconW = $$value)), iconW);
	...
	const mouseover_handler = () => ($$invalidate(3, isHovering = true), dispatch("mouseover"));
	const mouseout_handler = () => ($$invalidate(3, isHovering = false), dispatch("mouseout"));
	...
	$$self.$$set = $$new_props => {
		...
		if ("hoverFillColour" in $$new_props) $$invalidate(14, hoverFillColour = $$new_props.hoverFillColour);
		if ("hoverTwoToneFiler" in $$new_props) $$invalidate(15, hoverTwoToneFiler = $$new_props.hoverTwoToneFiler);
		if ("backgroundHoverColour" in $$new_props) $$invalidate(2, backgroundHoverColour = $$new_props.backgroundHoverColour);
	...
	$$self.$inject_state = $$new_props => {
		...
		if ("hoverFillColour" in $$props) $$invalidate(14, hoverFillColour = $$new_props.hoverFillColour);
		if ("hoverTwoToneFiler" in $$props) $$invalidate(15, hoverTwoToneFiler = $$new_props.hoverTwoToneFiler);
		if ("backgroundHoverColour" in $$props) $$invalidate(2, backgroundHoverColour = $$new_props.backgroundHoverColour);
		if ("isHovering" in $$props) $$invalidate(3, isHovering = $$new_props.isHovering);
		if ("currentFillColour" in $$props) $$invalidate(4, currentFillColour = $$new_props.currentFillColour);
		if ("currentTwoToneFilter" in $$props) $$invalidate(5, currentTwoToneFilter = $$new_props.currentTwoToneFilter);
	};
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*isHovering, hoverFillColour, hoverTwoToneFiler, fillColour, twoToneFilter*/ 61448) {
			$: (console.log("hover"), isHovering
			? (() => {
					$$invalidate(4, currentFillColour = hoverFillColour);
					$$invalidate(5, currentTwoToneFilter = hoverTwoToneFiler);
				})()
			: (() => {
					$$invalidate(4, currentFillColour = fillColour);
					$$invalidate(5, currentTwoToneFilter = twoToneFilter);
				})());
		}
	};
...
class FillOrTwoToneButton extends SvelteComponentDev {
	constructor(options) {
		...
		init(this, options, instance$2, create_fragment$2, safe_not_equal, {
			...
			fillColour: 13,
			hoverFillColour: 14,
			hoverTwoToneFiler: 15,
			backgroundHoverColour: 2
		});
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(heading, file$1, 52, 5, 1324);
		},
		m: function mount(target, anchor) {
...
// (45:3) <FillOrTwoToneButton      backgroundColour='transparent'      hoverColour='--colour-accent-secondary'      {icon}      on:mousein={() => {      }}     >
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(45:3) <FillOrTwoToneButton      backgroundColour='transparent'      hoverColour='--colour-accent-secondary'      {icon}      on:mousein={() => {      }}     >",
		ctx
	});
...
//# sourceMappingURL=DashboardRoute-5d120287.js.map
