...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container, "class", "outer arrow svelte-q5qo71");
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t2 = space();
			create_component(button.$$.fragment);
			attr_dev(container0, "class", "outer touch svelte-q5qo71");
			...
			attr_dev(container1, "class", "outer blinker svelte-q5qo71");
			...
			attr_dev(component_1, "class", "svelte-q5qo71");
...
//# sourceMappingURL=CallRoute-1b60f716.js.map
