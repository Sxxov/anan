...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = space();
			img = element("img");
			attr_dev(container, "class", container_class_value = "background " + (!/*isActive*/ ctx[8] ? "" : "inactive") + " svelte-vedry");
			set_style(container, "--colour-placeholder", CSSUtility.parse(/*placeholderColour*/ ctx[4]));
			add_location(container, file$3, 68, 1, 2362);
			if (img.src !== (img_src_value = /*realSrc*/ ctx[5])) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", /*alt*/ ctx[0]);
			attr_dev(img, "class", img_class_value = "" + (null_to_empty(/*isActive*/ ctx[8] ? "" : "inactive") + " svelte-vedry"));
			attr_dev(img, "draggable", "false");
			add_location(img, file$3, 74, 1, 2513);
			...
			attr_dev(component, "class", "svelte-vedry");
			add_location(component, file$3, 60, 0, 2163);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			if (dirty & /*isActive*/ 256 && container_class_value !== (container_class_value = "background " + (!/*isActive*/ ctx[8] ? "" : "inactive") + " svelte-vedry")) {
			...
			if (dirty & /*isActive*/ 256 && img_class_value !== (img_class_value = "" + (null_to_empty(/*isActive*/ ctx[8] ? "" : "inactive") + " svelte-vedry"))) {
...
//# sourceMappingURL=CallRoute-79a79e95.js.map
