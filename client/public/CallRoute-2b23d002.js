...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container, "class", "outer arrow svelte-ykt65n");
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t2 = space();
			create_component(button.$$.fragment);
			attr_dev(container0, "class", "outer touch svelte-ykt65n");
			...
			attr_dev(container1, "class", "outer blinker svelte-ykt65n");
			...
			attr_dev(component_1, "class", "svelte-ykt65n");
...
//# sourceMappingURL=CallRoute-2b23d002.js.map
