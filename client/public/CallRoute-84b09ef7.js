...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container0, "class", "outer arrow content svelte-1nm1bbr");
			add_location(container0, file$2, 121, 3, 3894);
			attr_dev(container1, "class", "outer arrow wrapper svelte-1nm1bbr");
			...
			add_location(container1, file$2, 113, 2, 3686);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(113:1) {#if isArrowEnabled}",
		ctx
	});
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t2 = space();
			create_component(button.$$.fragment);
			attr_dev(container0, "class", "outer touch svelte-1nm1bbr");
			set_style(container0, "--outer-transform", "scale(" + /*$scaleW*/ ctx[6] + ")");
			set_style(container0, "--outer-filter", "blur(" + (/*$scaleW*/ ctx[6] - 2) + "px)");
			add_location(container0, file$2, 104, 1, 3500);
			attr_dev(container1, "class", "outer blinker svelte-1nm1bbr");
			toggle_class(container1, "paused", !/*isBlinkerActive*/ ctx[10]);
			add_location(container1, file$2, 126, 1, 3971);
			...
			attr_dev(component_1, "class", "svelte-1nm1bbr");
			add_location(component_1, file$2, 94, 0, 3247);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$2($$self, $$props, $$invalidate) {
	...
	function onMouseUp() {
		...
		isHolding = false;
		const keyframes = [{ transform: `scale(${$scaleW})` }, { transform: "scale(1)" }];
		...
		animation = outer.animate(keyframes, options);
		arrow.animate(keyframes, options);
	...
	function onMouseMove(event) {
		...
		set_store_value(scaleW, $scaleW = distanceNormalized * (WindowUtility.viewport.max / 100) * 3 + 1, $scaleW);
	}
...
//# sourceMappingURL=CallRoute-84b09ef7.js.map
