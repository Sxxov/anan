...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = space();
			create_component(button.$$.fragment);
			attr_dev(container, "class", "outer svelte-1qfq1cg");
			...
			attr_dev(component_1, "class", "svelte-1qfq1cg");
...
//# sourceMappingURL=CallRoute-4136aad7.js.map
