...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container, file$3, 62, 1, 2156);
			...
			add_location(img, file$3, 68, 1, 2307);
			...
			add_location(component, file$3, 55, 0, 2008);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=CallRoute-7667c80a.js.map
