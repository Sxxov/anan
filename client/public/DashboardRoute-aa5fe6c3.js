...
function create_default_slot_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(string, file$1, 87, 5, 10778);
		},
		m: function mount(target, anchor) {
...
function create_default_slot_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			string.textContent = `${RandomUtility.int(2)}`;
			attr_dev(string, "class", "svelte-1wf6h1y");
			add_location(string, file$1, 106, 5, 11325);
		},
		m: function mount(target, anchor) {
			insert_dev(target, string, anchor);
		},
...
function create_default_slot_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(string, "class", "svelte-1wf6h1y");
			add_location(string, file$1, 124, 5, 11750);
		},
		m: function mount(target, anchor) {
			insert_dev(target, string, anchor);
		},
...
function create_default_slot$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			set_style(container4, "--colour-fill-hover", "#1da1f2");
			add_location(container4, file$1, 73, 3, 10337);
			attr_dev(container5, "class", "retweet svelte-1wf6h1y");
			set_style(container5, "--colour-fill-hover", "#17bf63");
			add_location(container5, file$1, 92, 3, 10882);
			attr_dev(container6, "class", "like svelte-1wf6h1y");
			set_style(container6, "--colour-fill-hover", "var(--colour-accent-primary)");
			add_location(container6, file$1, 111, 3, 11429);
...
//# sourceMappingURL=DashboardRoute-aa5fe6c3.js.map
