...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			set_style(container0, "--outer-transform", "scale(" + /*$scaleW*/ ctx[3] + ")");
			set_style(container0, "--outer-filter", "blur(" + (/*$scaleW*/ ctx[3] - 2) + "px)");
			add_location(container0, file$2, 92, 1, 2988);
			attr_dev(container1, "class", "outer blinker svelte-1yry869");
			toggle_class(container1, "paused", !/*isBlinkerActive*/ ctx[6]);
			add_location(container1, file$2, 100, 1, 3150);
			set_style(component_1, "--colour-background", CSSUtility.parse(/*backgroundColour*/ ctx[0]));
			attr_dev(component_1, "class", "svelte-1yry869");
			add_location(component_1, file$2, 83, 0, 2787);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		m: function mount(target, anchor) {
			...
			/*container0_binding*/ ctx[16](container0);
			...
			/*component_1_binding*/ ctx[18](component_1);
			current = true;
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*isBlinkerActive*/ 64) {
				toggle_class(container1, "paused", !/*isBlinkerActive*/ ctx[6]);
			}

			const button_changes = (dirty & /*buttonColour, hoverColour, $$restProps*/ 4102)
		...
		d: function destroy(detaching) {
			...
			/*container0_binding*/ ctx[16](null);
			destroy_component(button);
			/*component_1_binding*/ ctx[18](null);
			mounted = false;
			run_all(dispose);
		}
	};
...
function instance$2($$self, $$props, $$invalidate) {
	const omit_props_names = ["backgroundColour","buttonColour","hoverColour","isBlinkerEnabled","threshold"];
	let $$restProps = compute_rest_props($$props, omit_props_names);
	let $scaleW;
	let { $$slots: slots = {}, $$scope } = $$props;
	...
	component_subscribe($$self, scaleW, value => $$invalidate(3, $scaleW = value));
	...
	function onMouseMove(event) {
		...
		if (distance > threshold) {
			$$invalidate(15, isThresholdCrossed = true);
		} else {
			$$invalidate(15, isThresholdCrossed = false);
		}
	...
	$$self.$$set = $$new_props => {
		...
		if ("isBlinkerEnabled" in $$new_props) $$invalidate(13, isBlinkerEnabled = $$new_props.isBlinkerEnabled);
	...
	$$self.$inject_state = $$new_props => {
		...
		if ("isBlinkerEnabled" in $$props) $$invalidate(13, isBlinkerEnabled = $$new_props.isBlinkerEnabled);
		...
		if ("isBlinkerActive" in $$props) $$invalidate(6, isBlinkerActive = $$new_props.isBlinkerActive);
		if ("isThresholdCrossed" in $$props) $$invalidate(15, isThresholdCrossed = $$new_props.isThresholdCrossed);
	};
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*$scaleW, isBlinkerEnabled*/ 8200) {
			$: $scaleW === 1 && isBlinkerEnabled
			? $$invalidate(6, isBlinkerActive = true)
			: $$invalidate(6, isBlinkerActive = false);
		}

		if ($$self.$$.dirty & /*isThresholdCrossed*/ 32768) {
			$: isThresholdCrossed && dispatch("threshold");
		}
	};
...
//# sourceMappingURL=CallRoute-3e05c3f8.js.map
