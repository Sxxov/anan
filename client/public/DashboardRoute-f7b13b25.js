...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(iconf, file$2, 48, 3, 1503);
		},
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(icon_1, file$2, 40, 3, 1364);
		},
		m: function mount(target, anchor) {
...
function create_default_slot$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container, file$2, 38, 1, 1326);
		},
		m: function mount(target, anchor) {
...
//# sourceMappingURL=DashboardRoute-f7b13b25.js.map
