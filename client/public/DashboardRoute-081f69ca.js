...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(iconf, file$2, 32, 2, 960);
		},
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(icon_1, file$2, 24, 2, 834);
		},
		m: function mount(target, anchor) {
...
// (17:0) <Button   on:click={() => dispatch('click')}   on:mouseover={() => dispatch('mouseover')}   on:mousein={() => dispatch('mousein')}   on:mouseout={() => dispatch('mouseout')}   {...$$restProps}  >
function create_default_slot$2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(17:0) <Button   on:click={() => dispatch('click')}   on:mouseover={() => dispatch('mouseover')}   on:mousein={() => dispatch('mousein')}   on:mouseout={() => dispatch('mouseout')}   {...$$restProps}  >",
		ctx
	});
...
function create_fragment$2(ctx) {
	let button;
	let current;
	const button_spread_levels = [/*$$restProps*/ ctx[9]];
	...
	const block = {
		...
		p: function update(ctx, [dirty]) {
			...
			? get_spread_update(button_spread_levels, [get_spread_object(/*$$restProps*/ ctx[9])])
			: {};
...
//# sourceMappingURL=DashboardRoute-081f69ca.js.map
