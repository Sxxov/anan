...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container0, "class", "image border svelte-m4zbhn");
			add_location(container0, file$2, 20, 2, 1089);
			attr_dev(container1, "class", "image wrapper svelte-m4zbhn");
...
//# sourceMappingURL=CallRoute-e0d05476.js.map
