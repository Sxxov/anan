...
// (63:3) <Card      width='100%'      height='200px'     >
function create_default_slot_4(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(63:3) <Card      width='100%'      height='200px'     >",
		ctx
	});
...
function create_default_slot_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(string, file$1, 89, 5, 10901);
		},
		m: function mount(target, anchor) {
...
// (102:4) <FillOrTwoToneButton       backgroundColour='transparent'       hoverColour='--colour-fill-hover-secondary'       hoverFillColour='--colour-fill-hover-primary'       hoverTwoToneFilter='brightness(0) saturate(100%) invert(52%) sepia(57%) saturate(796%) hue-rotate(98deg) brightness(101%) contrast(82%)'       icon='wine_bar'       iconSize='1.4rem'      >
function create_default_slot_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			string.textContent = `${RandomUtility.int(2)}`;
			attr_dev(string, "class", "svelte-uj7p3r");
			add_location(string, file$1, 109, 5, 11522);
		},
		m: function mount(target, anchor) {
			insert_dev(target, string, anchor);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(102:4) <FillOrTwoToneButton       backgroundColour='transparent'       hoverColour='--colour-fill-hover-secondary'       hoverFillColour='--colour-fill-hover-primary'       hoverTwoToneFilter='brightness(0) saturate(100%) invert(52%) sepia(57%) saturate(796%) hue-rotate(98deg) brightness(101%) contrast(82%)'       icon='wine_bar'       iconSize='1.4rem'      >",
		ctx
	});
...
function create_default_slot_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(string, "class", "svelte-uj7p3r");
			add_location(string, file$1, 128, 5, 12042);
		},
		m: function mount(target, anchor) {
			insert_dev(target, string, anchor);
		},
...
function create_default_slot$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			set_style(a, "color", "var(--colour-text-primary)");
			...
			add_location(string1, file$1, 59, 3, 10176);
			attr_dev(container3, "class", "content svelte-uj7p3r");
			add_location(container3, file$1, 56, 2, 10136);
			...
			add_location(container4, file$1, 74, 3, 10386);
			...
			add_location(container5, file$1, 94, 3, 11005);
			...
			add_location(container6, file$1, 114, 3, 11626);
			attr_dev(container7, "class", "actions svelte-uj7p3r");
			add_location(container7, file$1, 71, 2, 10346);
...
//# sourceMappingURL=DashboardRoute-ee57e8b7.js.map
