...
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container0, "class", "sidebar svelte-19y3tut");
			add_location(container0, file, 14, 2, 329);
			attr_dev(heading, "class", "svelte-19y3tut");
			add_location(heading, file, 25, 4, 479);
			attr_dev(component0, "class", "header svelte-19y3tut");
			add_location(component0, file, 22, 3, 437);
			attr_dev(container1, "class", "main svelte-19y3tut");
			add_location(container1, file, 19, 2, 400);
			attr_dev(component1, "class", "svelte-19y3tut");
...
//# sourceMappingURL=DashboardRoute-068f262a.js.map
