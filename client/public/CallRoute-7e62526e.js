...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container0, "class", "image border svelte-d4xac3");
			add_location(container0, file$2, 20, 2, 1089);
			attr_dev(container1, "class", "image wrapper svelte-d4xac3");
...
//# sourceMappingURL=CallRoute-7e62526e.js.map
