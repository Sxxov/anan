...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container0, file$5, 133, 3, 4420);
			...
			add_location(container1, file$5, 125, 2, 4199);
		},
		m: function mount(target, anchor) {
...
function create_fragment$5(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container1, file$5, 138, 1, 4497);
...
// (26:1) <Card    isPadded={false}    isFloatingInverted={true}    roundness='100%'   >
function create_default_slot$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container0, file$2, 33, 3, 1351);
			attr_dev(container1, "class", "image wrapper svelte-d6xp1o");
			add_location(container1, file$2, 30, 2, 1305);
		},
		m: function mount(target, anchor) {
			insert_dev(target, container1, anchor);
			append_dev(container1, container0);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(26:1) <Card    isPadded={false}    isFloatingInverted={true}    roundness='100%'   >",
		ctx
	});
...
function create_fragment$2(ctx) {
	let component;
	let heading;
	let t0_value = CaseUtility.title(/*contact*/ ctx[0]) + "";
	let t0;
	let t1;
	let spacer;
	let t2;
	let card;
	let current;
	spacer = new Spacer({ props: { height: 56 }, $$inline: true });
	...
	const block = {
		c: function create() {
			...
			add_location(heading, file$2, 19, 1, 1136);
			add_location(component, file$2, 18, 0, 1122);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			if ((!current || dirty & /*contact*/ 1) && t0_value !== (t0_value = CaseUtility.title(/*contact*/ ctx[0]) + "")) set_data_dev(t0, t0_value);
			const card_changes = {};
...
function create_default_slot$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container4, file$1, 69, 2, 1718);
...
//# sourceMappingURL=CallRoute-d853637a.js.map
