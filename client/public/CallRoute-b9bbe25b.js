...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = space();
			container0 = element("container");
			attr_dev(container0, "class", "image border svelte-1qljuag");
			add_location(container0, file$2, 27, 2, 1300);
			attr_dev(container1, "class", "image wrapper");
...
//# sourceMappingURL=CallRoute-b9bbe25b.js.map
