...
function create_default_slot_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(string, "class", "svelte-r46id4");
...
function create_default_slot$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container0, "class", "frame svelte-r46id4");
			add_location(container0, file$1, 30, 3, 9663);
			attr_dev(container1, "class", "pp svelte-r46id4");
...
//# sourceMappingURL=DashboardRoute-5204b0cf.js.map
