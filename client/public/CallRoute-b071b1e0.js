...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container0, file$2, 135, 3, 4479);
			...
			add_location(container1, file$2, 127, 2, 4258);
		},
		m: function mount(target, anchor) {
			insert_dev(target, container1, anchor);
			append_dev(container1, container0);
			/*container1_binding*/ ctx[24](container1);
		},
		p: function update(ctx, dirty) {
			if (dirty[0] & /*arrowRotationDeg, $scaleW*/ 4224) {
				set_style(container1, "--arrow-transform", "rotate(" + /*arrowRotationDeg*/ ctx[12] + "deg) scale(" + /*$scaleW*/ ctx[7] + ")");
			}

			if (dirty[0] & /*$scaleW*/ 128) {
				set_style(container1, "--arrow-filter", "blur(" + Math.min(/*$scaleW*/ ctx[7] - 2, 5) + "px)");
			}
		},
		d: function destroy(detaching) {
			if (detaching) detach_dev(container1);
			/*container1_binding*/ ctx[24](null);
		}
	};
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(127:1) {#if isArrowEnabled}",
		ctx
	});
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(component_1, file$2, 107, 0, 3769);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		m: function mount(target, anchor) {
			...
			/*container0_binding*/ ctx[23](container0);
			...
			/*component_1_binding*/ ctx[26](component_1);
			current = true;

			if (!mounted) {
				dispose = [
					listen_dev(window, "mousemove", /*onMouseMove*/ ctx[18], false, false, false),
					listen_dev(window, "touchmove", /*onMouseMove*/ ctx[18], false, false, false),
					listen_dev(window, "mouseup", /*onMouseUp*/ ctx[17], false, false, false),
					listen_dev(window, "mousedown", /*onWindowMouseDown*/ ctx[15], false, false, false),
					listen_dev(component_1, "touchstart", /*onMouseDown*/ ctx[16], { passive: true }, false, false),
					listen_dev(component_1, "mousedown", /*onMouseDown*/ ctx[16], false, false, false),
					listen_dev(component_1, "touchend", /*onMouseUp*/ ctx[17], { passive: true }, false, false)
				];
		...
		p: function update(ctx, dirty) {
			...
			if (dirty[0] & /*isBlinkerActive*/ 2048) {
				toggle_class(container1, "paused", !/*isBlinkerActive*/ ctx[11]);
			}

			const button_changes = (dirty[0] & /*buttonColour, hoverColour, size, $$restProps*/ 524364)
			? get_spread_update(button_spread_levels, [
					button_spread_levels[0],
					dirty[0] & /*buttonColour*/ 4 && {
						backgroundColour: /*buttonColour*/ ctx[2]
					},
					dirty[0] & /*hoverColour*/ 8 && { hoverColour: /*hoverColour*/ ctx[3] },
					dirty[0] & /*size*/ 64 && { height: /*size*/ ctx[6] },
					dirty[0] & /*size*/ 64 && { width: /*size*/ ctx[6] },
					dirty[0] & /*size*/ 64 && { padding: (/*size*/ ctx[6] - 16) / 2 },
			...
			if (!current || dirty[0] & /*arrowColour*/ 2) {
				set_style(component_1, "--colour-arrow", CSSUtility.parse(/*arrowColour*/ ctx[1]));
			}
		...
		d: function destroy(detaching) {
			...
			/*container0_binding*/ ctx[23](null);
			if (if_block) if_block.d();
			destroy_component(button);
			/*component_1_binding*/ ctx[26](null);
			mounted = false;
			run_all(dispose);
		}
	};
...
function instance$2($$self, $$props, $$invalidate) {
	...
	let $isThresholdCrossedW,
		...
		$$subscribe_isThresholdCrossedW = () => ($$unsubscribe_isThresholdCrossedW(), $$unsubscribe_isThresholdCrossedW = subscribe(isThresholdCrossedW, $$value => $$invalidate(22, $isThresholdCrossedW = $$value)), isThresholdCrossedW);
	...
	$$self.$$set = $$new_props => {
		...
		if ("isBlinkerEnabled" in $$new_props) $$invalidate(20, isBlinkerEnabled = $$new_props.isBlinkerEnabled);
		if ("isArrowEnabled" in $$new_props) $$invalidate(4, isArrowEnabled = $$new_props.isArrowEnabled);
		if ("threshold" in $$new_props) $$invalidate(21, threshold = $$new_props.threshold);
	...
	$$self.$inject_state = $$new_props => {
		...
		if ("isBlinkerEnabled" in $$props) $$invalidate(20, isBlinkerEnabled = $$new_props.isBlinkerEnabled);
		if ("isArrowEnabled" in $$props) $$invalidate(4, isArrowEnabled = $$new_props.isArrowEnabled);
		if ("threshold" in $$props) $$invalidate(21, threshold = $$new_props.threshold);
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty[0] & /*$scaleW, isBlinkerEnabled*/ 1048704) {
			$: $scaleW === 1 && isBlinkerEnabled
			? $$invalidate(11, isBlinkerActive = true)
			: $$invalidate(11, isBlinkerActive = false);
		}

		if ($$self.$$.dirty[0] & /*$isThresholdCrossedW*/ 4194304) {
...
function create_default_slot$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container0, "class", "gradient svelte-1hus7tn");
			add_location(container0, file$1, 34, 1, 1003);
			attr_dev(container1, "class", "answer svelte-1hus7tn");
			add_location(container1, file$1, 44, 3, 1145);
			attr_dev(container2, "class", "reject svelte-1hus7tn");
			add_location(container2, file$1, 67, 3, 1790);
			attr_dev(container3, "class", "buttons svelte-1hus7tn");
			add_location(container3, file$1, 41, 2, 1105);
			attr_dev(container4, "class", "content svelte-1hus7tn");
		...
		m: function mount(target, anchor) {
			...
			mount_component(expandingbutton0, container1, null);
			append_dev(container3, t1);
			append_dev(container3, container2);
			mount_component(expandingbutton1, container2, null);
			current = true;
		},
		p: noop,
		i: function intro(local) {
...
//# sourceMappingURL=CallRoute-b071b1e0.js.map
