...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container0, file$2, 123, 3, 4028);
			...
			set_style(container1, "--arrow-filter", "blur(" + Math.min(/*$scaleW*/ ctx[6] - 2, 5) + "px)");
			add_location(container1, file$2, 115, 2, 3807);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			set_style(container0, "--outer-filter", "blur(" + Math.min(/*$scaleW*/ ctx[6] - 2, 5) + "px)");
			...
			add_location(container1, file$2, 128, 1, 4105);
...
//# sourceMappingURL=CallRoute-d3fafcd5.js.map
