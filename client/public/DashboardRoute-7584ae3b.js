...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(heading, file$1, 32, 4, 854);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(32:3) {#if $isTitlesEnabledW}",
		ctx
	});
...
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(29:2) <FillOrStrokeButton     {icon}    >",
		ctx
	});
...
// (28:1) {#each Object.entries(IconAndTitleMap) as [icon, title]}
function create_each_block(ctx) {
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			...
			if (dirty & /*$$scope, $isTitlesEnabledW*/ 258) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(28:1) {#each Object.entries(IconAndTitleMap) as [icon, title]}",
		ctx
	});
...
// (19:0) <Fragment   isPadded={false}   isInAnimated={true}   isOutAnimated={true}   height='100vh'   width='100%'   justify='center'  >
function create_default_slot$1(ctx) {
	...
	let each_value = Object.entries(/*IconAndTitleMap*/ ctx[2]);
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			if (dirty & /*Object, IconAndTitleMap, $isTitlesEnabledW*/ 6) {
				each_value = Object.entries(/*IconAndTitleMap*/ ctx[2]);
				validate_each_argument(each_value);
				let i;
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(19:0) <Fragment   isPadded={false}   isInAnimated={true}   isOutAnimated={true}   height='100vh'   width='100%'   justify='center'  >",
		ctx
	});
...
function instance$1($$self, $$props, $$invalidate) {
	...
	return [isTitlesEnabledW, $isTitlesEnabledW, IconAndTitleMap, isTitlesEnabled];
}
...
//# sourceMappingURL=DashboardRoute-7584ae3b.js.map
