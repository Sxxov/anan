...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = space();
			create_component(button.$$.fragment);
			attr_dev(container, "class", "outer svelte-voiolm");
			...
			attr_dev(component_1, "class", "svelte-voiolm");
...
//# sourceMappingURL=CallRoute-93d12cdc.js.map
