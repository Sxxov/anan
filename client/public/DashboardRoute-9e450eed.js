...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(heading, file$1, 44, 4, 1140);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(44:3) {#if $isTitlesEnabledW}",
		ctx
	});
...
// (38:2) <FillOrStrokeButton     backgroundColour='transparent'     hoverColour='--colour-accent-secondary'          {icon}    >
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(38:2) <FillOrStrokeButton     backgroundColour='transparent'     hoverColour='--colour-accent-secondary'          {icon}    >",
		ctx
	});
...
// (37:1) {#each IconAndTitleEntries as [icon, title]}
function create_each_block(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(37:1) {#each IconAndTitleEntries as [icon, title]}",
		ctx
	});
...
//# sourceMappingURL=DashboardRoute-9e450eed.js.map
