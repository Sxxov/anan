...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container0, "class", "outer arrow content svelte-1axyvku");
			add_location(container0, file$2, 121, 3, 3886);
			attr_dev(container1, "class", "outer arrow svelte-1axyvku");
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t2 = space();
			create_component(button.$$.fragment);
			attr_dev(container0, "class", "outer touch svelte-1axyvku");
			...
			attr_dev(container1, "class", "outer blinker svelte-1axyvku");
			toggle_class(container1, "paused", !/*isBlinkerActive*/ ctx[10]);
			add_location(container1, file$2, 126, 1, 3963);
			...
			attr_dev(component_1, "class", "svelte-1axyvku");
...
//# sourceMappingURL=CallRoute-33e59d50.js.map
