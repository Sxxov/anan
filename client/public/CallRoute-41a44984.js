...
// (16:0) <AppBar   bind:expandedHeightW   bind:baseHeightW   bind:isSpacedW   bind:isSpaced   {...$$restProps}  >
function create_default_slot$2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(16:0) <AppBar   bind:expandedHeightW   bind:baseHeightW   bind:isSpacedW   bind:isSpaced   {...$$restProps}  >",
		ctx
	});
...
// (46:4) <Button       backgroundColour='--colour-text-primary'       hoverColour='--colour-text-secondary'       textColour='--colour-background-primary'       icon='settings'      >
function create_default_slot_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(46:4) <Button       backgroundColour='--colour-text-primary'       hoverColour='--colour-text-secondary'       textColour='--colour-background-primary'       icon='settings'      >",
		ctx
	});
...
function create_default_slot$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container0, file$1, 32, 1, 913);
			attr_dev(container1, "class", "customize svelte-1k3e064");
			add_location(container1, file$1, 42, 3, 1055);
			attr_dev(container2, "class", "submit svelte-1k3e064");
			add_location(container2, file$1, 54, 3, 1327);
			attr_dev(container3, "class", "buttons svelte-1k3e064");
			add_location(container3, file$1, 39, 2, 1015);
			attr_dev(container4, "class", "content svelte-1k3e064");
			add_location(container4, file$1, 36, 1, 978);
		},
		m: function mount(target, anchor) {
...
function create_appBar_slot(ctx) {
	...
	let closableappbar;
	let current;
	closableappbar = new ClosableAppBar({ props: { title: "" }, $$inline: true });
...
//# sourceMappingURL=CallRoute-41a44984.js.map
