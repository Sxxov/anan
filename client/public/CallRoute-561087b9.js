...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container0, file$2, 125, 3, 4088);
			...
			add_location(container1, file$2, 117, 2, 3867);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(component_1, file$2, 97, 0, 3378);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function create_default_slot$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container0, "class", "gradient svelte-1avuxb0");
			add_location(container0, file$1, 34, 1, 1003);
			attr_dev(container1, "class", "answer svelte-1avuxb0");
			add_location(container1, file$1, 44, 3, 1145);
			attr_dev(container2, "class", "reject svelte-1avuxb0");
			add_location(container2, file$1, 65, 3, 1741);
			attr_dev(container3, "class", "buttons svelte-1avuxb0");
			add_location(container3, file$1, 41, 2, 1105);
			attr_dev(container4, "class", "content svelte-1avuxb0");
...
//# sourceMappingURL=CallRoute-561087b9.js.map
