...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container0, "class", "image border svelte-lhm1jl");
			add_location(container0, file$2, 20, 2, 1089);
			attr_dev(container1, "class", "image wrapper svelte-lhm1jl");
...
//# sourceMappingURL=CallRoute-92b12d30.js.map
