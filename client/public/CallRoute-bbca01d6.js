...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container0, "class", "image border svelte-8ngo2i");
			add_location(container0, file$2, 20, 2, 1089);
			attr_dev(container1, "class", "image wrapper svelte-8ngo2i");
...
//# sourceMappingURL=CallRoute-bbca01d6.js.map
