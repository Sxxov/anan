...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container, file$2, 61, 1, 2123);
			attr_dev(component_1, "class", "svelte-e1nm");
			add_location(component_1, file$2, 54, 0, 1973);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=CallRoute-3840aaf9.js.map
