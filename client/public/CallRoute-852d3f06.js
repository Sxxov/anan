...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			set_style(container0, "--outer-filter", "blur(" + (/*$scaleW*/ ctx[2] - 1) + "px)");
...
//# sourceMappingURL=CallRoute-852d3f06.js.map
