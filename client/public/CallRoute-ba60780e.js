...
// (110:1) {#if isArrowEnabled}
function create_if_block(ctx) {
	let container;
	let container_style_value;

	const block = {
		c: function create() {
			container = element("container");
			attr_dev(container, "class", "outer arrow svelte-100fhn5");
			attr_dev(container, "style", container_style_value = "\r\n\t\t\t\t--arrow-transform: rotate(" + /*arrowRotationDeg*/ ctx[11] + "deg); scale(" + /*$scaleW*/ ctx[6] + ");\r\n\t\t\t\t--arrow-filter: blur(" + (/*$scaleW*/ ctx[6] - 2) + "px);\r\n\t\t\t");
			add_location(container, file$2, 110, 2, 3581);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, dirty) {
			if (dirty & /*arrowRotationDeg, $scaleW*/ 2112 && container_style_value !== (container_style_value = "\r\n\t\t\t\t--arrow-transform: rotate(" + /*arrowRotationDeg*/ ctx[11] + "deg); scale(" + /*$scaleW*/ ctx[6] + ");\r\n\t\t\t\t--arrow-filter: blur(" + (/*$scaleW*/ ctx[6] - 2) + "px);\r\n\t\t\t")) {
				attr_dev(container, "style", container_style_value);
			}
		},
		d: function destroy(detaching) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(110:1) {#if isArrowEnabled}",
		ctx
	});
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t2 = space();
			create_component(button.$$.fragment);
			attr_dev(container0, "class", "outer touch svelte-100fhn5");
			set_style(container0, "--outer-transform", "scale(" + /*$scaleW*/ ctx[6] + ")");
			set_style(container0, "--outer-filter", "blur(" + (/*$scaleW*/ ctx[6] - 2) + "px)");
			add_location(container0, file$2, 101, 1, 3395);
			attr_dev(container1, "class", "outer blinker svelte-100fhn5");
			toggle_class(container1, "paused", !/*isBlinkerActive*/ ctx[10]);
			add_location(container1, file$2, 119, 1, 3789);
			...
			attr_dev(component_1, "class", "svelte-100fhn5");
			add_location(component_1, file$2, 91, 0, 3142);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=CallRoute-ba60780e.js.map
