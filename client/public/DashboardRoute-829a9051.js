...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			iconf = element("iconf");
			t = text(/*$iconW*/ ctx[8]);
			set_style(iconf, "--colour-fill", CSSUtility.parse(/*currentFillColour*/ ctx[5]));
			set_style(iconf, "--icon-size", CSSUtility.parse(/*iconSize*/ ctx[2]));
			attr_dev(iconf, "class", "svelte-883be8");
			add_location(iconf, file$2, 49, 3, 1564);
		},
		...
		p: function update(ctx, dirty) {
			if (dirty & /*$iconW*/ 256) set_data_dev(t, /*$iconW*/ ctx[8]);

			if (dirty & /*currentFillColour*/ 32) {
				set_style(iconf, "--colour-fill", CSSUtility.parse(/*currentFillColour*/ ctx[5]));
			}
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			icon_1 = element("icon");
			t = text(/*$iconW*/ ctx[8]);
			set_style(icon_1, "--filter-twotone", CSSUtility.parse(/*currentTwoToneFilter*/ ctx[6]));
			set_style(icon_1, "--icon-size", CSSUtility.parse(/*iconSize*/ ctx[2]));
			attr_dev(icon_1, "class", "svelte-883be8");
			add_location(icon_1, file$2, 40, 3, 1376);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, dirty) {
			...
			if (dirty & /*currentTwoToneFilter*/ 64) {
				set_style(icon_1, "--filter-twotone", CSSUtility.parse(/*currentTwoToneFilter*/ ctx[6]));
			}
...
// (31:0) <Button   on:click={() => dispatch('click')}   on:mouseover={() => ((isHovering = true), dispatch('mouseover'))}   on:mouseout={() => ((isHovering = false),  dispatch('mouseout'))}   hoverColour={backgroundHoverColour}   {...$$restProps}   isText={false}  >
function create_default_slot$2(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*$isTwoToneW*/ ctx[7]) return create_if_block$1;
	...
	const block = {
		c: function create() {
			...
			add_location(container, file$2, 38, 1, 1338);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(31:0) <Button   on:click={() => dispatch('click')}   on:mouseover={() => ((isHovering = true), dispatch('mouseover'))}   on:mouseout={() => ((isHovering = false),  dispatch('mouseout'))}   hoverColour={backgroundHoverColour}   {...$$restProps}   isText={false}  >",
		ctx
	});
...
function create_fragment$2(ctx) {
	...
	button.$on("mouseover", /*mouseover_handler*/ ctx[19]);
	button.$on("mouseout", /*mouseout_handler*/ ctx[20]);
	...
	const block = {
		...
		p: function update(ctx, [dirty]) {
			const button_changes = (dirty & /*backgroundHoverColour, $$restProps*/ 1032)
			...
			if (dirty & /*$$scope, currentTwoToneFilter, iconSize, $iconW, $isTwoToneW, currentFillColour*/ 2097636) {
...
function instance$2($$self, $$props, $$invalidate) {
	const omit_props_names = [
		"isTwoTone","isTwoToneW","icon","iconW","iconSize","twoToneFilter","fillColour","hoverFillColour","hoverTwoToneFiler","backgroundHoverColour"
	];
	...
	let $isTwoToneW,
		...
		$$subscribe_isTwoToneW = () => ($$unsubscribe_isTwoToneW(), $$unsubscribe_isTwoToneW = subscribe(isTwoToneW, $$value => $$invalidate(7, $isTwoToneW = $$value)), isTwoToneW);

	let $iconW,
		$$unsubscribe_iconW = noop,
		$$subscribe_iconW = () => ($$unsubscribe_iconW(), $$unsubscribe_iconW = subscribe(iconW, $$value => $$invalidate(8, $iconW = $$value)), iconW);
	...
	const mouseover_handler = () => ($$invalidate(4, isHovering = true), dispatch("mouseover"));
	const mouseout_handler = () => ($$invalidate(4, isHovering = false), dispatch("mouseout"));

	$$self.$$set = $$new_props => {
		$$props = assign(assign({}, $$props), exclude_internal_props($$new_props));
		$$invalidate(10, $$restProps = compute_rest_props($$props, omit_props_names));
		if ("isTwoTone" in $$new_props) $$invalidate(11, isTwoTone = $$new_props.isTwoTone);
		...
		if ("twoToneFilter" in $$new_props) $$invalidate(13, twoToneFilter = $$new_props.twoToneFilter);
		if ("fillColour" in $$new_props) $$invalidate(14, fillColour = $$new_props.fillColour);
		if ("hoverFillColour" in $$new_props) $$invalidate(15, hoverFillColour = $$new_props.hoverFillColour);
		if ("hoverTwoToneFiler" in $$new_props) $$invalidate(16, hoverTwoToneFiler = $$new_props.hoverTwoToneFiler);
	...
	$$self.$inject_state = $$new_props => {
		if ("isTwoTone" in $$props) $$invalidate(11, isTwoTone = $$new_props.isTwoTone);
		...
		if ("twoToneFilter" in $$props) $$invalidate(13, twoToneFilter = $$new_props.twoToneFilter);
		if ("fillColour" in $$props) $$invalidate(14, fillColour = $$new_props.fillColour);
		if ("hoverFillColour" in $$props) $$invalidate(15, hoverFillColour = $$new_props.hoverFillColour);
		if ("hoverTwoToneFiler" in $$props) $$invalidate(16, hoverTwoToneFiler = $$new_props.hoverTwoToneFiler);
		if ("backgroundHoverColour" in $$props) $$invalidate(3, backgroundHoverColour = $$new_props.backgroundHoverColour);
		if ("isHovering" in $$props) $$invalidate(4, isHovering = $$new_props.isHovering);
		if ("currentFillColour" in $$props) $$invalidate(5, currentFillColour = $$new_props.currentFillColour);
		if ("currentTwoToneFilter" in $$props) $$invalidate(6, currentTwoToneFilter = $$new_props.currentTwoToneFilter);
	};
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*isHovering, hoverFillColour, hoverTwoToneFiler, fillColour, twoToneFilter*/ 122896) {
			$: (console.log("hover"), isHovering
			? (() => {
					$$invalidate(5, currentFillColour = hoverFillColour);
					$$invalidate(6, currentTwoToneFilter = hoverTwoToneFiler);
				})()
			: (() => {
					$$invalidate(5, currentFillColour = fillColour);
					$$invalidate(6, currentTwoToneFilter = twoToneFilter);
				})());
		}
	};
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = text(t_value);
			attr_dev(heading, "class", "svelte-bda4rd");
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = space();
			attr_dev(container, "class", "button");
...
//# sourceMappingURL=DashboardRoute-829a9051.js.map
