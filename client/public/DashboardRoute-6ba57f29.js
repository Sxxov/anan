...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(iconf, file$2, 34, 3, 1004);
		},
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(icon_1, file$2, 26, 3, 870);
		},
		m: function mount(target, anchor) {
...
function create_default_slot$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container, file$2, 24, 1, 832);
		},
		m: function mount(target, anchor) {
...
//# sourceMappingURL=DashboardRoute-6ba57f29.js.map
