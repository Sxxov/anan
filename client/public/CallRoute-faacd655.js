...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container0, file$2, 127, 3, 4027);
			...
			add_location(container1, file$2, 119, 2, 3819);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(119:1) {#if isArrowEnabled}",
		ctx
	});
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(component_1, file$2, 100, 0, 3380);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$2($$self, $$props, $$invalidate) {
	...
	function onMouseUp() {
		...
		animation = outer.animate([{ transform: `scale(${$scaleW})` }, { transform: "scale(1)" }], options);

		arrow.animate(
			[
				{
					transform: `rotate(${arrowRotationDeg}deg) scale(${$scaleW})`
				},
...
//# sourceMappingURL=CallRoute-faacd655.js.map
