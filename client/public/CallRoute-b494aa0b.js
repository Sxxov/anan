...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container0, file$2, 129, 3, 4315);
			...
			add_location(container1, file$2, 121, 2, 4094);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(121:1) {#if isArrowEnabled}",
		ctx
	});
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(component_1, file$2, 101, 0, 3605);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$2($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty & /*$isThresholdCrossedW*/ 2097152) {
			$: scaleEnd = $isThresholdCrossedW ? 1 : 10;
		}

		if ($$self.$$.dirty & /*$isThresholdCrossedW*/ 2097152) {
			$: opacityEnd = $isThresholdCrossedW ? 1 : 0;
		}
	};
...
function create_default_slot$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container2, file$1, 66, 3, 1769);
...
//# sourceMappingURL=CallRoute-b494aa0b.js.map
