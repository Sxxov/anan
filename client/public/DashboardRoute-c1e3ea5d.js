...
function create_default_slot_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			string.textContent = `${RandomUtility.int(2)}`;
			attr_dev(string, "class", "svelte-30rvcr");
			add_location(string, file$1, 109, 5, 11478);
		},
		m: function mount(target, anchor) {
			insert_dev(target, string, anchor);
		},
...
function create_default_slot_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(string, "class", "svelte-30rvcr");
			add_location(string, file$1, 128, 5, 11998);
		},
		m: function mount(target, anchor) {
			insert_dev(target, string, anchor);
		},
...
function create_default_slot$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container6, file$1, 114, 3, 11582);
			attr_dev(container7, "class", "actions svelte-30rvcr");
			add_location(container7, file$1, 71, 2, 10302);
...
//# sourceMappingURL=DashboardRoute-c1e3ea5d.js.map
