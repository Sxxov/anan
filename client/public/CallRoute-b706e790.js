...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container0, file$2, 134, 3, 4465);
			...
			add_location(container1, file$2, 126, 2, 4244);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(component_1, file$2, 106, 0, 3755);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, dirty) {
			...
			const button_changes = (dirty[0] & /*buttonColour, hoverColour, size, $$restProps*/ 262220)
...
function instance$2($$self, $$props, $$invalidate) {
	...
	function onMouseMove(event) {
		...
		isBlinkerActive || $$invalidate(11, isBlinkerActive = true);
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty[0] & /*$scaleW, isBlinkerEnabled*/ 524416) {
			$: $scaleW === 1 && isBlinkerEnabled
			? $$invalidate(11, isBlinkerActive = true)
			: $$invalidate(11, isBlinkerActive = false);
		}

		if ($$self.$$.dirty[0] & /*$isThresholdCrossedW*/ 2097152) {
...
//# sourceMappingURL=CallRoute-b706e790.js.map
