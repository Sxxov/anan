...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(iconf, "class", "svelte-hcist2");
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(icon_1, "class", "svelte-hcist2");
...
function create_default_slot$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container, "class", "svelte-hcist2");
...
//# sourceMappingURL=DashboardRoute-21051089.js.map
