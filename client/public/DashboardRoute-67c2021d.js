...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = text(t_value);
			attr_dev(heading, "class", "svelte-1le9ezd");
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = space();
			attr_dev(container, "class", "button svelte-1le9ezd");
...
function create_default_slot$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			each_1_anchor = empty();
			attr_dev(container, "class", "logo svelte-1le9ezd");
...
//# sourceMappingURL=DashboardRoute-67c2021d.js.map
