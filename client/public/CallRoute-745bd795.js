...
function create_default_slot$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container0, "class", "gradient svelte-ghtulq");
			add_location(container0, file$1, 34, 1, 1003);
			attr_dev(container1, "class", "answer svelte-ghtulq");
			add_location(container1, file$1, 44, 3, 1145);
			attr_dev(container2, "class", "reject svelte-ghtulq");
			add_location(container2, file$1, 65, 3, 1741);
			attr_dev(container3, "class", "buttons svelte-ghtulq");
			add_location(container3, file$1, 41, 2, 1105);
			attr_dev(container4, "class", "content svelte-ghtulq");
...
//# sourceMappingURL=CallRoute-745bd795.js.map
