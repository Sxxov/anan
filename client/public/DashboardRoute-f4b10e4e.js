...
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container, "class", "sidebar svelte-2hbax7");
...
//# sourceMappingURL=DashboardRoute-f4b10e4e.js.map
