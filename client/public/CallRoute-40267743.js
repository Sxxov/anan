...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container, file$2, 95, 1, 2961);
			attr_dev(component_1, "class", "svelte-15wlqew");
			add_location(component_1, file$2, 89, 0, 2836);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$2($$self, $$props, $$invalidate) {
	...
	function onMouseMove(event) {
		...
		set_store_value(scaleW, $scaleW = distanceNormalized * (Math.max(WindowUtility.viewport.width, WindowUtility.viewport.height) / 100) * 2 + 1, $scaleW);
	}
...
//# sourceMappingURL=CallRoute-40267743.js.map
