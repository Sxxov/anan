...
function create_fragment$2(ctx) {
	...
	const button_spread_levels = [
		{ icon: "clear" },
		{
			backgroundColour: /*buttonColour*/ ctx[1]
		},
		{ hoverColour: /*hoverColour*/ ctx[2] },
		{ padding: 20 },
		/*$$restProps*/ ctx[13]
	];
	...
	const block = {
		c: function create() {
			...
			t1 = space();
			create_component(button.$$.fragment);
			attr_dev(container0, "class", "outer touch svelte-1yry869");
			set_style(container0, "--outer-transform", "scale(" + /*$scaleW*/ ctx[4] + ")");
			set_style(container0, "--outer-filter", "blur(" + (/*$scaleW*/ ctx[4] - 2) + "px)");
			add_location(container0, file$2, 92, 1, 3109);
			attr_dev(container1, "class", "outer blinker svelte-1yry869");
			toggle_class(container1, "paused", !/*isBlinkerActive*/ ctx[7]);
			add_location(container1, file$2, 100, 1, 3271);
			set_style(component_1, "--colour-background", CSSUtility.parse(/*backgroundColour*/ ctx[0]));
			attr_dev(component_1, "class", "svelte-1yry869");
			add_location(component_1, file$2, 83, 0, 2908);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		m: function mount(target, anchor) {
			...
			/*container0_binding*/ ctx[17](container0);
			...
			/*component_1_binding*/ ctx[19](component_1);
			current = true;

			if (!mounted) {
				dispose = [
					listen_dev(window, "mousemove", /*onMouseMove*/ ctx[12], false, false, false),
					listen_dev(window, "touchmove", /*onMouseMove*/ ctx[12], false, false, false),
					listen_dev(window, "mouseup", /*onMouseUp*/ ctx[11], false, false, false),
					listen_dev(component_1, "touchstart", /*onMouseDown*/ ctx[10], { passive: true }, false, false),
					listen_dev(component_1, "mousedown", /*onMouseDown*/ ctx[10], false, false, false),
					listen_dev(component_1, "touchend", /*onMouseUp*/ ctx[11], { passive: true }, false, false)
				];
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*isBlinkerActive*/ 128) {
				toggle_class(container1, "paused", !/*isBlinkerActive*/ ctx[7]);
			}

			const button_changes = (dirty & /*buttonColour, hoverColour, $$restProps*/ 8198)
			? get_spread_update(button_spread_levels, [
					button_spread_levels[0],
					dirty & /*buttonColour*/ 2 && {
						backgroundColour: /*buttonColour*/ ctx[1]
					},
					dirty & /*hoverColour*/ 4 && { hoverColour: /*hoverColour*/ ctx[2] },
		...
		d: function destroy(detaching) {
			...
			/*container0_binding*/ ctx[17](null);
			destroy_component(button);
			/*component_1_binding*/ ctx[19](null);
			mounted = false;
			run_all(dispose);
		}
	};
...
function instance$2($$self, $$props, $$invalidate) {
	const omit_props_names = [
		"backgroundColour","buttonColour","hoverColour","isBlinkerEnabled","threshold","isThresholdCrossedW"
	];
	...
	let $isThresholdCrossedW,
		...
		$$subscribe_isThresholdCrossedW = () => ($$unsubscribe_isThresholdCrossedW(), $$unsubscribe_isThresholdCrossedW = subscribe(isThresholdCrossedW, $$value => $$invalidate(16, $isThresholdCrossedW = $$value)), isThresholdCrossedW);
	...
	function onMouseMove(event) {
		...
		const { left, top, bottom, right, height, width } = component.getBoundingClientRect();
		const x2 = left + width / 2;
		const y2 = top + height / 2;
		const ix2 = right - width / 2;
		const iy2 = bottom - height / 2;
		const distance = Math.hypot(x2 - x1, y2 - y1);
		const distanceNormalized = distance / Math.hypot(WindowUtility.viewport.height - Math.min(y2, iy2), WindowUtility.viewport.width - Math.min(x2, ix2));
		console.log("distanceNormalized", distanceNormalized);
	...
	$$self.$$set = $$new_props => {
		...
		if ("buttonColour" in $$new_props) $$invalidate(1, buttonColour = $$new_props.buttonColour);
		if ("hoverColour" in $$new_props) $$invalidate(2, hoverColour = $$new_props.hoverColour);
		if ("isBlinkerEnabled" in $$new_props) $$invalidate(14, isBlinkerEnabled = $$new_props.isBlinkerEnabled);
		if ("threshold" in $$new_props) $$invalidate(15, threshold = $$new_props.threshold);
		if ("isThresholdCrossedW" in $$new_props) $$subscribe_isThresholdCrossedW($$invalidate(3, isThresholdCrossedW = $$new_props.isThresholdCrossedW));
	};
	...
	$$self.$inject_state = $$new_props => {
		...
		if ("buttonColour" in $$props) $$invalidate(1, buttonColour = $$new_props.buttonColour);
		if ("hoverColour" in $$props) $$invalidate(2, hoverColour = $$new_props.hoverColour);
		if ("isBlinkerEnabled" in $$props) $$invalidate(14, isBlinkerEnabled = $$new_props.isBlinkerEnabled);
		if ("threshold" in $$props) $$invalidate(15, threshold = $$new_props.threshold);
		if ("isThresholdCrossedW" in $$props) $$subscribe_isThresholdCrossedW($$invalidate(3, isThresholdCrossedW = $$new_props.isThresholdCrossedW));
		if ("component" in $$props) $$invalidate(5, component = $$new_props.component);
		if ("outer" in $$props) $$invalidate(6, outer = $$new_props.outer);
		if ("isHolding" in $$props) isHolding = $$new_props.isHolding;
		if ("animation" in $$props) animation = $$new_props.animation;
		if ("isBlinkerActive" in $$props) $$invalidate(7, isBlinkerActive = $$new_props.isBlinkerActive);
	};
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*$scaleW, isBlinkerEnabled*/ 16400) {
			$: $scaleW === 1 && isBlinkerEnabled
			? $$invalidate(7, isBlinkerActive = true)
			: $$invalidate(7, isBlinkerActive = false);
		}

		if ($$self.$$.dirty & /*$isThresholdCrossedW*/ 65536) {
...
//# sourceMappingURL=CallRoute-1e0a97a9.js.map
