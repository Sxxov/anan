...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container0, file$2, 127, 3, 4024);
			...
			add_location(container1, file$2, 119, 2, 3816);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(component_1, file$2, 100, 0, 3377);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$2($$self, $$props, $$invalidate) {
	...
	function onMouseUp() {
		...
		arrow.animate(
			[
				{
					transform: `rotate(${arrowRotationDeg}) scale(${$scaleW})`
				},
...
//# sourceMappingURL=CallRoute-0e4fece4.js.map
