...
function create_default_slot_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(string, "class", "svelte-1x8qqqf");
...
function create_default_slot$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container5, "class", "retweet svelte-1x8qqqf");
			...
			attr_dev(container6, "class", "like svelte-1x8qqqf");
			...
			attr_dev(container7, "class", "report svelte-1x8qqqf");
			...
			attr_dev(container8, "class", "actions svelte-1x8qqqf");
			add_location(container8, file$1, 71, 2, 10302);
			attr_dev(component, "class", "svelte-1x8qqqf");
...
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container0, "class", "sidebar svelte-1k8hgtz");
			add_location(container0, file, 14, 2, 329);
			attr_dev(heading, "class", "svelte-1k8hgtz");
			add_location(heading, file, 25, 4, 479);
			attr_dev(component0, "class", "header svelte-1k8hgtz");
			add_location(component0, file, 22, 3, 437);
			attr_dev(container1, "class", "main svelte-1k8hgtz");
			add_location(container1, file, 19, 2, 400);
			attr_dev(component1, "class", "svelte-1k8hgtz");
...
//# sourceMappingURL=DashboardRoute-1d50fe5b.js.map
