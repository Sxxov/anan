...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(heading, file$1, 55, 5, 1360);
		},
		m: function mount(target, anchor) {
...
// (48:3) <FillOrTwoToneButton      backgroundColour='transparent'      hoverColour='--colour-accent-secondary'      {icon}      isTwoTone={i !== activeIndex}      iconSize='1.4rem'     >
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(48:3) <FillOrTwoToneButton      backgroundColour='transparent'      hoverColour='--colour-accent-secondary'      {icon}      isTwoTone={i !== activeIndex}      iconSize='1.4rem'     >",
		ctx
	});
...
//# sourceMappingURL=DashboardRoute-d5a76153.js.map
