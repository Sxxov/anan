...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = text(t_value);
			attr_dev(heading, "class", "svelte-12etbr1");
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = space();
			attr_dev(container, "class", "button svelte-12etbr1");
...
//# sourceMappingURL=DashboardRoute-293a5a9d.js.map
