...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t1 = space();
			create_component(button.$$.fragment);
			attr_dev(container0, "class", "outer touch svelte-15ys7dv");
			set_style(container0, "--outer-transform", "scale(" + /*$scaleW*/ ctx[2] + ")");
			set_style(container0, "--outer-filter", "blur(" + /*$scaleW*/ ctx[2] * 10 + "px)");
			add_location(container0, file$2, 80, 1, 2578);
			attr_dev(container1, "class", "outer blinker svelte-15ys7dv");
			toggle_class(container1, "paused", /*isBlinkerPaused*/ ctx[5]);
			add_location(container1, file$2, 88, 1, 2741);
			set_style(component_1, "--colour-background", CSSUtility.parse(/*backgroundColour*/ ctx[0]));
			attr_dev(component_1, "class", "svelte-15ys7dv");
			add_location(component_1, file$2, 71, 0, 2377);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		m: function mount(target, anchor) {
			...
			/*container0_binding*/ ctx[11](container0);
			...
			/*component_1_binding*/ ctx[13](component_1);
			current = true;

			if (!mounted) {
				dispose = [
					listen_dev(window, "mousemove", /*onMouseMove*/ ctx[10], false, false, false),
					listen_dev(window, "touchmove", /*onMouseMove*/ ctx[10], false, false, false),
					listen_dev(window, "mouseup", /*onMouseUp*/ ctx[9], false, false, false),
					listen_dev(component_1, "touchstart", /*onMouseDown*/ ctx[8], { passive: true }, false, false),
					listen_dev(component_1, "mousedown", /*onMouseDown*/ ctx[8], false, false, false),
					listen_dev(component_1, "touchend", /*onMouseUp*/ ctx[9], { passive: true }, false, false)
				];
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*isBlinkerPaused*/ 32) {
				toggle_class(container1, "paused", /*isBlinkerPaused*/ ctx[5]);
			}

			const button_changes = {};
			if (dirty & /*buttonColour*/ 2) button_changes.backgroundColour = /*buttonColour*/ ctx[1];
		...
		d: function destroy(detaching) {
			...
			/*container0_binding*/ ctx[11](null);
			destroy_component(button);
			/*component_1_binding*/ ctx[13](null);
			mounted = false;
			run_all(dispose);
		}
	};
...
function instance$2($$self, $$props, $$invalidate) {
	...
	let isHolding = false;
	let animation = null;
	let isBlinkerPaused = false;
	const scaleW = writable(1);
	validate_store(scaleW, "scaleW");
	component_subscribe($$self, scaleW, value => $$invalidate(2, $scaleW = value));
	...
	const writable_props = ["backgroundColour", "buttonColour"];
	...
	$$self.$$set = $$props => {
		...
		if ("buttonColour" in $$props) $$invalidate(1, buttonColour = $$props.buttonColour);
	};
	...
	$$self.$inject_state = $$props => {
		...
		if ("outer" in $$props) $$invalidate(4, outer = $$props.outer);
		if ("isHolding" in $$props) isHolding = $$props.isHolding;
		if ("animation" in $$props) animation = $$props.animation;
		if ("isBlinkerPaused" in $$props) $$invalidate(5, isBlinkerPaused = $$props.isBlinkerPaused);
	};
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*$scaleW*/ 4) {
			$: $scaleW === 1
			? $$invalidate(5, isBlinkerPaused = false)
			: $$invalidate(5, isBlinkerPaused = true);
		}
	};
...
class ExpandingButton extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$2, create_fragment$2, safe_not_equal, { backgroundColour: 0, buttonColour: 1 });
...
//# sourceMappingURL=CallRoute-39204f82.js.map
