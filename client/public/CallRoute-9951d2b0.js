...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = space();
			create_component(button.$$.fragment);
			attr_dev(container, "class", "outer svelte-e1nm");
			set_style(container, "--transform", "scale(" + /*$scaleW*/ ctx[3] + ")");
			set_style(container, "--colour-background", /*backgroundColour*/ ctx[0]);
			add_location(container, file$2, 87, 1, 2784);
			attr_dev(component_1, "class", "svelte-e1nm");
			add_location(component_1, file$2, 80, 0, 2634);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		m: function mount(target, anchor) {
			...
			append_dev(component_1, container);
			append_dev(component_1, t);
			mount_component(button, component_1, null);
			/*component_1_binding*/ ctx[12](component_1);
			current = true;

			if (!mounted) {
				dispose = [
					listen_dev(window, "mousemove", /*onMouseMove*/ ctx[8], false, false, false),
					listen_dev(window, "touchmove", /*onMouseMove*/ ctx[8], false, false, false),
					listen_dev(component_1, "touchstart", /*onMouseDown*/ ctx[6], { passive: true }, false, false),
					listen_dev(component_1, "mousedown", /*onMouseDown*/ ctx[6], false, false, false),
					listen_dev(component_1, "touchend", /*onMouseUp*/ ctx[7], { passive: true }, false, false),
					listen_dev(component_1, "mouseup", /*onMouseUp*/ ctx[7], false, false, false)
				];
		...
		d: function destroy(detaching) {
			...
			/*component_1_binding*/ ctx[12](null);
			mounted = false;
			run_all(dispose);
		}
	};
...
function instance$2($$self, $$props, $$invalidate) {
	...
	function onMouseMove(event) {
		...
		const { left: x2, top: y2 } = component.getBoundingClientRect();
		const distance = Math.hypot(x2 - x1, y2 - y1);
		const distanceNormalized = distance / Math.hypot(WindowUtility.viewport.height, WindowUtility.viewport.width);
		set_store_value(scaleW, $scaleW = distanceNormalized * 2 + 1, $scaleW);
	}
	...
	$$self.$inject_state = $$props => {
		...
		if ("animation" in $$props) $$invalidate(9, animation = $$props.animation);
		if ("lastScaleValue" in $$props) $$invalidate(10, lastScaleValue = $$props.lastScaleValue);
	};
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*$scaleW, component, lastScaleValue, animation*/ 1548) {
			$: ($scaleW, component && (() => {
				$$invalidate(9, animation = component.animate(
					[
				...
				animation.addEventListener("finish", () => {
					$$invalidate(10, lastScaleValue = $scaleW);
					$$invalidate(9, animation = null);
				});
...
//# sourceMappingURL=CallRoute-9951d2b0.js.map
