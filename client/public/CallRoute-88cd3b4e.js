...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = space();
			create_component(button.$$.fragment);
			attr_dev(container, "class", "outer svelte-18gi3j7");
			...
			attr_dev(component_1, "class", "svelte-18gi3j7");
...
//# sourceMappingURL=CallRoute-88cd3b4e.js.map
