...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(iconf, "class", "svelte-a3g9bf");
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(icon_1, "class", "svelte-a3g9bf");
...
function create_default_slot$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container, "class", "svelte-a3g9bf");
...
//# sourceMappingURL=DashboardRoute-70357514.js.map
