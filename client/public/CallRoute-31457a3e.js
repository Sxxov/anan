...
function instance$2($$self, $$props, $$invalidate) {
	...
	function onMouseMove(event) {
		...
		const distanceNormalized = distance / Math.hypot(WindowUtility.viewport.height - Math.min(x2, ix2), WindowUtility.viewport.width - Math.min(y2, iy2));
...
//# sourceMappingURL=CallRoute-31457a3e.js.map
