...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container0, file$2, 123, 3, 4001);
			...
			add_location(container1, file$2, 115, 2, 3793);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(component_1, file$2, 96, 0, 3354);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$2($$self, $$props, $$invalidate) {
	...
	const bezierUtility = new BezierUtility(0.5, 0, 0, 1);
...
//# sourceMappingURL=CallRoute-b6d171d6.js.map
