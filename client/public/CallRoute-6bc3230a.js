...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container0, "class", "outer arrow content svelte-18v9dku");
			add_location(container0, file$2, 121, 3, 3894);
			attr_dev(container1, "class", "outer arrow wrapper svelte-18v9dku");
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t2 = space();
			create_component(button.$$.fragment);
			attr_dev(container0, "class", "outer touch svelte-18v9dku");
			...
			attr_dev(container1, "class", "outer blinker svelte-18v9dku");
			...
			attr_dev(component_1, "class", "svelte-18v9dku");
...
//# sourceMappingURL=CallRoute-6bc3230a.js.map
