...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container, file$2, 16, 1, 971);
			add_location(component, file$2, 15, 0, 957);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
class Contact extends SvelteComponentDev {
	constructor(options) {
		...
		if (/*contact*/ ctx[0] === undefined && !("contact" in props)) {
			console.warn("<Contact> was created without expected prop 'contact'");
		}
	}
...
//# sourceMappingURL=CallRoute-e42baa3f.js.map
