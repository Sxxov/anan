...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t1 = space();
			create_component(button.$$.fragment);
			attr_dev(container0, "class", "outer touch svelte-1wpl9ph");
			set_style(container0, "--outer-transform", "scale(" + /*$scaleW*/ ctx[4] + ")");
			add_location(container0, file$2, 98, 1, 3037);
			attr_dev(container1, "class", "outer blinker svelte-1wpl9ph");
			add_location(container1, file$2, 105, 1, 3157);
			set_style(component_1, "--colour-background", CSSUtility.parse(/*backgroundColour*/ ctx[0]));
			attr_dev(component_1, "class", "svelte-1wpl9ph");
		...
		m: function mount(target, anchor) {
			...
			/*container0_binding*/ ctx[10](container0);
		...
		d: function destroy(detaching) {
			...
			/*container0_binding*/ ctx[10](null);
...
//# sourceMappingURL=CallRoute-d0cf1f88.js.map
