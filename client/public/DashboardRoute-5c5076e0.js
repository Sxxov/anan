...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(heading, file$1, 55, 5, 1367);
		},
		m: function mount(target, anchor) {
...
// (49:3) <FillOrTwoToneButton      backgroundColour='transparent'      hoverColour='--colour-accent-secondary'      {icon}      iconSize='1.4rem'     >
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(49:3) <FillOrTwoToneButton      backgroundColour='transparent'      hoverColour='--colour-accent-secondary'      {icon}      iconSize='1.4rem'     >",
		ctx
	});
...
// (45:1) {#each IconAndTitleEntries as [icon, title], i}
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container, file$1, 45, 2, 1150);
		},
		m: function mount(target, anchor) {
			insert_dev(target, container, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(45:1) {#each IconAndTitleEntries as [icon, title], i}",
		ctx
	});
...
function create_default_slot$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container, file$1, 35, 1, 966);
		},
		m: function mount(target, anchor) {
			insert_dev(target, container, anchor);
...
//# sourceMappingURL=DashboardRoute-5c5076e0.js.map
