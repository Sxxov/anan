...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			set_style(container0, "--outer-filter", "blur(" + /*$scaleW*/ ctx[2] + "px)");
			...
			add_location(container1, file$2, 88, 1, 2736);
...
//# sourceMappingURL=CallRoute-455ac54f.js.map
