...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = space();
			img = element("img");
			attr_dev(container, "class", container_class_value = "background " + (!/*isActive*/ ctx[8] ? "" : "inactive") + " svelte-108huj2");
			set_style(container, "--colour-placeholder", CSSUtility.parse(/*placeholderColour*/ ctx[4]));
			add_location(container, file$3, 68, 1, 2358);
			if (img.src !== (img_src_value = /*realSrc*/ ctx[5])) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", /*alt*/ ctx[0]);
			attr_dev(img, "class", img_class_value = "" + (null_to_empty(/*isActive*/ ctx[8] ? "" : "inactive") + " svelte-108huj2"));
			attr_dev(img, "draggable", "false");
			add_location(img, file$3, 74, 1, 2509);
			set_style(component, "--width", CSSUtility.parse(/*$widthW*/ ctx[9]));
			set_style(component, "--height", CSSUtility.parse(/*$heightW*/ ctx[10]));
			set_style(component, "--roundness", CSSUtility.parse(/*roundness*/ ctx[3]));
			attr_dev(component, "class", "svelte-108huj2");
		...
		p: function update(ctx, [dirty]) {
			if (dirty & /*isActive*/ 256 && container_class_value !== (container_class_value = "background " + (!/*isActive*/ ctx[8] ? "" : "inactive") + " svelte-108huj2")) {
			...
			if (dirty & /*isActive*/ 256 && img_class_value !== (img_class_value = "" + (null_to_empty(/*isActive*/ ctx[8] ? "" : "inactive") + " svelte-108huj2"))) {
...
//# sourceMappingURL=CallRoute-e88b982d.js.map
