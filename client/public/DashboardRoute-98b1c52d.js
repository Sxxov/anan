...
function create_default_slot_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(string, "class", "svelte-1r22ym6");
			add_location(string, file$1, 86, 5, 10728);
		},
		m: function mount(target, anchor) {
...
// (98:4) <FillOrTwoToneButton       backgroundColour='transparent'       hoverFillColour='--colour'       hoverTwoToneFilter='brightness(0) saturate(100%) invert(52%) sepia(57%) saturate(796%) hue-rotate(98deg) brightness(101%) contrast(82%)'       icon='wine_bar'       iconSize='1rem'      >
function create_default_slot_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			string.textContent = `${RandomUtility.int(2)}`;
			attr_dev(string, "class", "svelte-1r22ym6");
			add_location(string, file$1, 104, 5, 11222);
		},
		m: function mount(target, anchor) {
			insert_dev(target, string, anchor);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(98:4) <FillOrTwoToneButton       backgroundColour='transparent'       hoverFillColour='--colour'       hoverTwoToneFilter='brightness(0) saturate(100%) invert(52%) sepia(57%) saturate(796%) hue-rotate(98deg) brightness(101%) contrast(82%)'       icon='wine_bar'       iconSize='1rem'      >",
		ctx
	});
...
function create_default_slot_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(string, "class", "svelte-1r22ym6");
			add_location(string, file$1, 121, 5, 11596);
		},
		m: function mount(target, anchor) {
			insert_dev(target, string, anchor);
		},
...
function create_default_slot$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(heading, "class", "svelte-1r22ym6");
			add_location(heading, file$1, 33, 4, 9704);
			attr_dev(container0, "class", "frame svelte-1r22ym6");
			add_location(container0, file$1, 30, 3, 9663);
			attr_dev(container1, "class", "pp svelte-1r22ym6");
			...
			attr_dev(container2, "class", "meta svelte-1r22ym6");
			add_location(container2, file$1, 38, 2, 9796);
			add_location(string1, file$1, 58, 3, 10128);
			attr_dev(container3, "class", "content svelte-1r22ym6");
			add_location(container3, file$1, 55, 2, 10088);
			attr_dev(container4, "class", "reply svelte-1r22ym6");
			set_style(container4, "--colour-fill-hover", "#1da1f2");
			add_location(container4, file$1, 73, 3, 10338);
			attr_dev(container5, "class", "retweet svelte-1r22ym6");
			set_style(container5, "--colour-fill-hover", "#17bf63");
			add_location(container5, file$1, 91, 3, 10832);
			attr_dev(container6, "class", "like svelte-1r22ym6");
			set_style(container6, "--colour-fill-hover", "var(--colour-accent-primary)");
			add_location(container6, file$1, 109, 3, 11326);
			attr_dev(container7, "class", "actions svelte-1r22ym6");
			add_location(container7, file$1, 70, 2, 10298);
			attr_dev(component, "class", "svelte-1r22ym6");
...
//# sourceMappingURL=DashboardRoute-98b1c52d.js.map
