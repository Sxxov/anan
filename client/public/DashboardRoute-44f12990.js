...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(heading, file$1, 34, 4, 959);
		},
		m: function mount(target, anchor) {
...
// (20:0) <Fragment   isPadded={false}   isInAnimated={true}   isOutAnimated={true}   height='100vh'   width='100%'   justify='center'   rows={`repeat(${IconAndTitleEntries.length}, 56px)`}  >
function create_default_slot$1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(20:0) <Fragment   isPadded={false}   isInAnimated={true}   isOutAnimated={true}   height='100vh'   width='100%'   justify='center'   rows={`repeat(${IconAndTitleEntries.length}, 56px)`}  >",
		ctx
	});
...
//# sourceMappingURL=DashboardRoute-44f12990.js.map
