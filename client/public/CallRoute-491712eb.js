...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container, "class", "outer arrow svelte-7ley89");
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t2 = space();
			create_component(button.$$.fragment);
			attr_dev(container0, "class", "outer touch svelte-7ley89");
			...
			attr_dev(container1, "class", "outer blinker svelte-7ley89");
			...
			attr_dev(component_1, "class", "svelte-7ley89");
...
//# sourceMappingURL=CallRoute-491712eb.js.map
