...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(iconf, file$2, 48, 3, 1525);
		},
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(icon_1, file$2, 40, 3, 1386);
		},
		m: function mount(target, anchor) {
...
// (30:0) <Button   on:click={() => dispatch('click')}   on:mouseover={() => dispatch('mouseover')}   on:mousein={() => ((isHovering = true), dispatch('mousein'))}   on:mouseout={() => ((isHovering = false),  dispatch('mouseout'))}   hoverColour={backgroundHoverColour}   {...$$restProps}   isText={false}  >
function create_default_slot$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container, file$2, 38, 1, 1348);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(30:0) <Button   on:click={() => dispatch('click')}   on:mouseover={() => dispatch('mouseover')}   on:mousein={() => ((isHovering = true), dispatch('mousein'))}   on:mouseout={() => ((isHovering = false),  dispatch('mouseout'))}   hoverColour={backgroundHoverColour}   {...$$restProps}   isText={false}  >",
		ctx
	});
...
function create_fragment$2(ctx) {
	...
	button.$on("mousein", /*mousein_handler*/ ctx[19]);
	...
	const block = {
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*$$scope, currentTwoToneFilter, $iconW, $isTwoToneW, currentFillColour*/ 2097392) {
...
function instance$2($$self, $$props, $$invalidate) {
	...
	const mousein_handler = () => ($$invalidate(3, isHovering = true), dispatch("mousein"));
...
//# sourceMappingURL=DashboardRoute-ca406b91.js.map
