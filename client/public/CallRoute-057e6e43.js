...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container0, file$2, 133, 3, 4426);
			...
			add_location(container1, file$2, 125, 2, 4205);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(component_1, file$2, 105, 0, 3716);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$2($$self, $$props, $$invalidate) {
	...
	$$self.$inject_state = $$new_props => {
		...
		if ("isHolding" in $$props) $$invalidate(21, isHolding = $$new_props.isHolding);
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty & /*isHolding*/ 2097152) {
			$: isHolding
			? $$invalidate(11, isBlinkerActive = false)
			: $$invalidate(11, isBlinkerActive = true);
		}

		if ($$self.$$.dirty & /*$isThresholdCrossedW*/ 4194304) {
...
//# sourceMappingURL=CallRoute-057e6e43.js.map
