...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container0, "class", "outer arrow content svelte-dscbv6");
			add_location(container0, file$2, 130, 3, 4350);
			attr_dev(container1, "class", "outer arrow wrapper svelte-dscbv6");
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t2 = space();
			create_component(button.$$.fragment);
			attr_dev(container0, "class", "outer touch svelte-dscbv6");
			...
			attr_dev(container1, "class", "outer blinker svelte-dscbv6");
			...
			attr_dev(component_1, "class", "svelte-dscbv6");
...
//# sourceMappingURL=CallRoute-8f553718.js.map
