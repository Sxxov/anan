...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = text(t_value);
			attr_dev(heading, "class", "svelte-jj2hjl");
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = space();
			attr_dev(container, "class", "button svelte-jj2hjl");
...
function create_default_slot$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			each_1_anchor = empty();
			attr_dev(container, "class", "logo svelte-jj2hjl");
...
//# sourceMappingURL=DashboardRoute-92c8c31e.js.map
