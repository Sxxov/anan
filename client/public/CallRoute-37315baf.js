...
function create_default_slot$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container0, file$2, 22, 3, 1145);
			attr_dev(container1, "class", "image wrapper svelte-16iv7ma");
			add_location(container1, file$2, 19, 2, 1099);
		},
		m: function mount(target, anchor) {
			insert_dev(target, container1, anchor);
			append_dev(container1, container0);
...
//# sourceMappingURL=CallRoute-37315baf.js.map
