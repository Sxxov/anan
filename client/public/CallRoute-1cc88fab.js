...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = space();
			img = element("img");
			attr_dev(container, "class", container_class_value = "background " + (!/*isActive*/ ctx[7] ? "" : "inactive") + " svelte-1db0vf7");
			set_style(container, "--colour-placeholder", CSSUtility.parse(/*placeholderColour*/ ctx[3]));
			add_location(container, file$3, 66, 1, 2284);
			if (img.src !== (img_src_value = /*realSrc*/ ctx[4])) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", /*alt*/ ctx[0]);
			attr_dev(img, "class", img_class_value = "" + (null_to_empty(/*isActive*/ ctx[7] ? "" : "inactive") + " svelte-1db0vf7"));
			attr_dev(img, "draggable", "false");
			add_location(img, file$3, 72, 1, 2435);
			set_style(component, "--width", CSSUtility.parse(/*$widthW*/ ctx[8]));
			set_style(component, "--height", CSSUtility.parse(/*$heightW*/ ctx[9]));
			attr_dev(component, "class", "svelte-1db0vf7");
			add_location(component, file$3, 59, 0, 2136);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			if (dirty & /*isActive*/ 128 && container_class_value !== (container_class_value = "background " + (!/*isActive*/ ctx[7] ? "" : "inactive") + " svelte-1db0vf7")) {
				attr_dev(container, "class", container_class_value);
			}

			if (dirty & /*placeholderColour*/ 8) {
				set_style(container, "--colour-placeholder", CSSUtility.parse(/*placeholderColour*/ ctx[3]));
			}

			if (dirty & /*realSrc*/ 16 && img.src !== (img_src_value = /*realSrc*/ ctx[4])) {
			...
			if (dirty & /*isActive*/ 128 && img_class_value !== (img_class_value = "" + (null_to_empty(/*isActive*/ ctx[7] ? "" : "inactive") + " svelte-1db0vf7"))) {
...
function instance$3($$self, $$props, $$invalidate) {
	...
	let $heightW,
		...
		$$subscribe_heightW = () => ($$unsubscribe_heightW(), $$unsubscribe_heightW = subscribe(heightW, $$value => $$invalidate(9, $heightW = $$value)), heightW);
	...
	(() => __awaiter(void 0, void 0, void 0, function* () {
		...
		if (result.default != null) {
			$$invalidate(4, realSrc = result.default);
			return;
		}

		$$invalidate(4, realSrc = result);
	}))();
	...
	function onLoad() {
		$$invalidate(7, isActive = true);
		dispatch("load");
	}

	const writable_props = ["src", "alt", "height", "width", "heightW", "widthW", "placeholderColour"];
	...
	$$self.$$set = $$props => {
		...
		if ("placeholderColour" in $$props) $$invalidate(3, placeholderColour = $$props.placeholderColour);
	};
	...
	$$self.$inject_state = $$props => {
		...
		if ("widthW" in $$props) $$subscribe_widthW($$invalidate(2, widthW = $$props.widthW));
		if ("placeholderColour" in $$props) $$invalidate(3, placeholderColour = $$props.placeholderColour);
		if ("realSrc" in $$props) $$invalidate(4, realSrc = $$props.realSrc);
		if ("imgDomContent" in $$props) $$invalidate(5, imgDomContent = $$props.imgDomContent);
		if ("componentDomContent" in $$props) $$invalidate(6, componentDomContent = $$props.componentDomContent);
		if ("isActive" in $$props) $$invalidate(7, isActive = $$props.isActive);
	};
...
//# sourceMappingURL=CallRoute-1cc88fab.js.map
