...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container0, file$2, 123, 3, 4030);
			...
			set_style(container1, "--arrow-filter", "blur(" + Math.min(/*$scaleW*/ ctx[6] - 2, 50) + "px)");
			add_location(container1, file$2, 115, 2, 3808);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			set_style(container0, "--outer-filter", "blur(" + Math.min(/*$scaleW*/ ctx[6] - 2, 50) + "px)");
			...
			add_location(container1, file$2, 128, 1, 4107);
...
//# sourceMappingURL=CallRoute-1d7447df.js.map
