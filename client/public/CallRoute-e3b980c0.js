...
// (19:1) <Card    isPadded={false}    borderRadius='100%'   >
function create_default_slot$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container0, file$2, 25, 3, 1191);
			attr_dev(container1, "class", "image wrapper svelte-16iv7ma");
			add_location(container1, file$2, 22, 2, 1145);
		},
		m: function mount(target, anchor) {
			insert_dev(target, container1, anchor);
			append_dev(container1, container0);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(19:1) <Card    isPadded={false}    borderRadius='100%'   >",
		ctx
	});
...
//# sourceMappingURL=CallRoute-e3b980c0.js.map
