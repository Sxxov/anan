...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		m: function mount(target, anchor) {
			...
			/*container0_binding*/ ctx[14](container0);
			...
			/*component_1_binding*/ ctx[16](component_1);
			current = true;
		...
		d: function destroy(detaching) {
			...
			/*container0_binding*/ ctx[14](null);
			destroy_component(button);
			/*component_1_binding*/ ctx[16](null);
			mounted = false;
			run_all(dispose);
		}
	};
...
function instance$2($$self, $$props, $$invalidate) {
	const omit_props_names = ["backgroundColour","buttonColour","hoverColour","isBlinkerEnabled"];
	let $$restProps = compute_rest_props($$props, omit_props_names);
	let $scaleW;
	let { $$slots: slots = {}, $$scope } = $$props;
...
function create_default_slot$1(ctx) {
	...
	expandingbutton0 = new ExpandingButton({
			props: { isBlinkerEnabled: true },
			$$inline: true
		});

	expandingbutton1 = new ExpandingButton({
			props: { isBlinkerEnabled: false },
			$$inline: true
		});
	...
	const block = {
		c: function create() {
			...
			add_location(container2, file$1, 59, 3, 1486);
...
//# sourceMappingURL=CallRoute-a497215a.js.map
