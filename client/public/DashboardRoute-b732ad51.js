...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(iconf, "class", "svelte-waua40");
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(icon_1, "class", "svelte-waua40");
...
function create_default_slot$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container, "class", "svelte-waua40");
...
//# sourceMappingURL=DashboardRoute-b732ad51.js.map
