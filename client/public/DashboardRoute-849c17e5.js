...
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container0, "class", "sidebar svelte-o1cqni");
			add_location(container0, file, 14, 2, 329);
			attr_dev(heading, "class", "svelte-o1cqni");
			add_location(heading, file, 25, 4, 479);
			attr_dev(component0, "class", "header svelte-o1cqni");
			add_location(component0, file, 22, 3, 437);
			attr_dev(container1, "class", "main svelte-o1cqni");
			add_location(container1, file, 19, 2, 400);
			attr_dev(component1, "class", "svelte-o1cqni");
...
//# sourceMappingURL=DashboardRoute-849c17e5.js.map
