...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(iconf, "class", "svelte-hej4dc");
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(icon_1, "class", "svelte-hej4dc");
...
function create_default_slot$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container, "class", "svelte-hej4dc");
...
//# sourceMappingURL=DashboardRoute-a701afdb.js.map
