...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t1 = space();
			create_component(button.$$.fragment);
			attr_dev(container0, "class", "outer touch svelte-1e4soou");
			set_style(container0, "--outer-transform", "scale(" + /*$scaleW*/ ctx[2] + ")");
			add_location(container0, file$2, 80, 1, 2578);
			attr_dev(container1, "class", "outer blinker svelte-1e4soou");
			...
			attr_dev(component_1, "class", "svelte-1e4soou");
...
//# sourceMappingURL=CallRoute-4284c3b2.js.map
