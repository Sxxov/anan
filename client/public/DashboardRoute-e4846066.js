...
// (24:0) <Button   on:click={() => dispatch('click')}   on:hover={() => dispatch('hover')}   {...$$restProps}  >
function create_default_slot$2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(24:0) <Button   on:click={() => dispatch('click')}   on:hover={() => dispatch('hover')}   {...$$restProps}  >",
		ctx
	});
...
function create_icon_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(placeholder_1, file$2, 28, 1, 952);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	button.$on("hover", /*hover_handler*/ ctx[12]);
	...
	const block = {
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*$$scope, placeholder, $iconW*/ 8204) {
...
function instance$2($$self, $$props, $$invalidate) {
	...
	const hover_handler = () => dispatch("hover");
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(heading, file$1, 45, 4, 1195);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(45:3) {#if $isTitlesEnabledW}",
		ctx
	});
...
// (39:2) <FillOrStrokeButton     backgroundColour='transparent'     hoverColour='--colour-accent-secondary'     on:hover={() => {}}     {icon}    >
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(39:2) <FillOrStrokeButton     backgroundColour='transparent'     hoverColour='--colour-accent-secondary'     on:hover={() => {}}     {icon}    >",
		ctx
	});
...
// (38:1) {#each IconAndTitleEntries as [icon, title]}
function create_each_block(ctx) {
	...
	fillorstrokebutton.$on("hover", hover_handler);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(38:1) {#each IconAndTitleEntries as [icon, title]}",
		ctx
	});
...
// (20:0) <Fragment   isPadded={true}   isInAnimated={true}   isOutAnimated={true}   padding='calc(var(--padding) / 2)'   height='100vh'   width='100%'   justify='flex-start'   rows={`repeat(${    // + logo    IconAndTitleEntries.length + 1   }, 56px)`}  >
function create_default_slot$1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(20:0) <Fragment   isPadded={true}   isInAnimated={true}   isOutAnimated={true}   padding='calc(var(--padding) / 2)'   height='100vh'   width='100%'   justify='flex-start'   rows={`repeat(${    // + logo    IconAndTitleEntries.length + 1   }, 56px)`}  >",
		ctx
	});
...
//# sourceMappingURL=DashboardRoute-e4846066.js.map
