...
// (22:1) <Card    isPadded={false}    isFloatingInverted={true}    roundness='100%'   >
function create_default_slot$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container0, "class", "image border svelte-16iv7ma");
			add_location(container0, file$2, 29, 3, 1274);
			attr_dev(container1, "class", "image wrapper svelte-16iv7ma");
			add_location(container1, file$2, 26, 2, 1228);
		},
		m: function mount(target, anchor) {
			insert_dev(target, container1, anchor);
			append_dev(container1, container0);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(22:1) <Card    isPadded={false}    isFloatingInverted={true}    roundness='100%'   >",
		ctx
	});
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(heading, file$2, 18, 1, 1089);
			add_location(component, file$2, 17, 0, 1075);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=CallRoute-74674469.js.map
