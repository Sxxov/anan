...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		m: function mount(target, anchor) {
			...
			/*container0_binding*/ ctx[13](container0);
			...
			/*component_1_binding*/ ctx[15](component_1);
			current = true;
		...
		p: function update(ctx, [dirty]) {
			...
			const button_changes = (dirty & /*buttonColour, hoverColour, $$restProps*/ 4108)
		...
		d: function destroy(detaching) {
			...
			/*container0_binding*/ ctx[13](null);
			destroy_component(button);
			/*component_1_binding*/ ctx[15](null);
			mounted = false;
			run_all(dispose);
		}
	};
...
function instance$2($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$new_props => {
		...
		if ("isBlinkerEnabled" in $$new_props) $$invalidate(0, isBlinkerEnabled = $$new_props.isBlinkerEnabled);
	};
	...
	$$self.$inject_state = $$new_props => {
		...
		if ("isBlinkerEnabled" in $$props) $$invalidate(0, isBlinkerEnabled = $$new_props.isBlinkerEnabled);
...
//# sourceMappingURL=CallRoute-6aec5048.js.map
