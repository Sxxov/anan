...
function create_default_slot_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(string, "class", "svelte-latutr");
...
function create_default_slot$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(heading, "class", "svelte-latutr");
			add_location(heading, file$1, 33, 4, 9704);
			attr_dev(container0, "class", "frame svelte-latutr");
			add_location(container0, file$1, 30, 3, 9663);
			attr_dev(container1, "class", "pp svelte-latutr");
...
//# sourceMappingURL=DashboardRoute-0ba3c6dc.js.map
