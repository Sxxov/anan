...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(container0, "class", "outer arrow content svelte-1wlizdr");
			add_location(container0, file$2, 123, 3, 4002);
			attr_dev(container1, "class", "outer arrow wrapper svelte-1wlizdr");
			set_style(container1, "--arrow-transform", "rotate(" + /*arrowRotationDeg*/ ctx[11] + "deg) scale(" + /*$scaleW*/ ctx[6] + ")");
			set_style(container1, "--arrow-filter", "blur(" + (/*$scaleW*/ ctx[6] - 2) + "px)");
			add_location(container1, file$2, 115, 2, 3794);
		},
		m: function mount(target, anchor) {
			insert_dev(target, container1, anchor);
			append_dev(container1, container0);
			/*container1_binding*/ ctx[22](container1);
		},
		p: function update(ctx, dirty) {
			if (dirty & /*arrowRotationDeg, $scaleW*/ 2112) {
				set_style(container1, "--arrow-transform", "rotate(" + /*arrowRotationDeg*/ ctx[11] + "deg) scale(" + /*$scaleW*/ ctx[6] + ")");
			}
		...
		d: function destroy(detaching) {
			...
			/*container1_binding*/ ctx[22](null);
		}
	};
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(115:1) {#if isArrowEnabled}",
		ctx
	});
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t2 = space();
			create_component(button.$$.fragment);
			attr_dev(container0, "class", "outer touch svelte-1wlizdr");
			set_style(container0, "--outer-transform", "scale(" + /*$scaleW*/ ctx[6] + ")");
			set_style(container0, "--outer-filter", "blur(" + (/*$scaleW*/ ctx[6] - 2) + "px)");
			add_location(container0, file$2, 106, 1, 3608);
			attr_dev(container1, "class", "outer blinker svelte-1wlizdr");
			toggle_class(container1, "paused", !/*isBlinkerActive*/ ctx[10]);
			add_location(container1, file$2, 128, 1, 4079);
			...
			attr_dev(component_1, "class", "svelte-1wlizdr");
			add_location(component_1, file$2, 96, 0, 3355);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		m: function mount(target, anchor) {
			...
			/*container0_binding*/ ctx[21](container0);
			...
			/*component_1_binding*/ ctx[24](component_1);
			current = true;

			if (!mounted) {
				dispose = [
					listen_dev(window, "mousemove", /*onMouseMove*/ ctx[16], false, false, false),
					listen_dev(window, "touchmove", /*onMouseMove*/ ctx[16], false, false, false),
					listen_dev(window, "mouseup", /*onMouseUp*/ ctx[15], false, false, false),
					listen_dev(component_1, "touchstart", /*onMouseDown*/ ctx[14], { passive: true }, false, false),
					listen_dev(component_1, "mousedown", /*onMouseDown*/ ctx[14], false, false, false),
					listen_dev(component_1, "touchend", /*onMouseUp*/ ctx[15], { passive: true }, false, false)
				];
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*isBlinkerActive*/ 1024) {
				toggle_class(container1, "paused", !/*isBlinkerActive*/ ctx[10]);
			}

			const button_changes = (dirty & /*buttonColour, hoverColour, $$restProps*/ 131084)
		...
		d: function destroy(detaching) {
			...
			/*container0_binding*/ ctx[21](null);
			if (if_block) if_block.d();
			destroy_component(button);
			/*component_1_binding*/ ctx[24](null);
			mounted = false;
			run_all(dispose);
		}
	};
...
function instance$2($$self, $$props, $$invalidate) {
	const omit_props_names = [
		"backgroundColour","arrowColour","buttonColour","hoverColour","isBlinkerEnabled","isArrowEnabled","threshold","isThresholdCrossedW"
	];
	...
	let $isThresholdCrossedW,
		...
		$$subscribe_isThresholdCrossedW = () => ($$unsubscribe_isThresholdCrossedW(), $$unsubscribe_isThresholdCrossedW = subscribe(isThresholdCrossedW, $$value => $$invalidate(20, $isThresholdCrossedW = $$value)), isThresholdCrossedW);
	...
	const bezierUtility = new BezierUtility(0.25, 0, 0, 1);
	const scaleW = writable(1);
	validate_store(scaleW, "scaleW");
	component_subscribe($$self, scaleW, value => $$invalidate(6, $scaleW = value));
	...
	function onMouseMove(event) {
		...
		if (isArrowEnabled) {
			$$invalidate(11, arrowRotationDeg = -(Math.atan((userX - buttonX) / (userY - buttonY)) * (180 / Math.PI) + Number(userY > buttonY && 180)));
		}
	...
	$$self.$$set = $$new_props => {
		...
		if ("isBlinkerEnabled" in $$new_props) $$invalidate(18, isBlinkerEnabled = $$new_props.isBlinkerEnabled);
		if ("isArrowEnabled" in $$new_props) $$invalidate(4, isArrowEnabled = $$new_props.isArrowEnabled);
		if ("threshold" in $$new_props) $$invalidate(19, threshold = $$new_props.threshold);
	...
	$$self.$inject_state = $$new_props => {
		...
		if ("isBlinkerEnabled" in $$props) $$invalidate(18, isBlinkerEnabled = $$new_props.isBlinkerEnabled);
		if ("isArrowEnabled" in $$props) $$invalidate(4, isArrowEnabled = $$new_props.isArrowEnabled);
		if ("threshold" in $$props) $$invalidate(19, threshold = $$new_props.threshold);
		...
		if ("outer" in $$props) $$invalidate(8, outer = $$new_props.outer);
		if ("arrow" in $$props) $$invalidate(9, arrow = $$new_props.arrow);
		if ("isHolding" in $$props) isHolding = $$new_props.isHolding;
		if ("animation" in $$props) animation = $$new_props.animation;
		if ("isBlinkerActive" in $$props) $$invalidate(10, isBlinkerActive = $$new_props.isBlinkerActive);
		if ("arrowRotationDeg" in $$props) $$invalidate(11, arrowRotationDeg = $$new_props.arrowRotationDeg);
	};
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*$scaleW, isBlinkerEnabled*/ 262208) {
			$: $scaleW === 1 && isBlinkerEnabled
			? $$invalidate(10, isBlinkerActive = true)
			: $$invalidate(10, isBlinkerActive = false);
		}

		if ($$self.$$.dirty & /*$isThresholdCrossedW*/ 1048576) {
...
function create_default_slot$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container2, file$1, 63, 3, 1710);
...
//# sourceMappingURL=CallRoute-d4314fa1.js.map
