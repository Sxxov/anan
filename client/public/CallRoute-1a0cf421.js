...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container, file$2, 92, 1, 2855);
			attr_dev(component_1, "class", "svelte-15wlqew");
			add_location(component_1, file$2, 86, 0, 2730);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=CallRoute-1a0cf421.js.map
