...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container, file$2, 86, 1, 2726);
			attr_dev(component_1, "class", "svelte-15wlqew");
			add_location(component_1, file$2, 79, 0, 2576);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$2($$self, $$props, $$invalidate) {
	...
	function onMouseMove(event) {
		...
		scaleW.set(distanceNormalized * 2 + 1);
	}
...
//# sourceMappingURL=CallRoute-ba044723.js.map
