...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(heading, file$1, 42, 4, 1109);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(42:3) {#if $isTitlesEnabledW}",
		ctx
	});
...
// (38:2) <FillOrStrokeButton     backgroundColour='--colour-background-secondary'     {icon}    >
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(38:2) <FillOrStrokeButton     backgroundColour='--colour-background-secondary'     {icon}    >",
		ctx
	});
...
//# sourceMappingURL=DashboardRoute-4867a3dd.js.map
