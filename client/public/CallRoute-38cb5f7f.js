...
// (44:4) <Button       backgroundColour='--colour-text-primary'       hoverColour='--colour-text-secondary'       textColour='--colour-background-primary'       icon='settings'      >
function create_default_slot_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(44:4) <Button       backgroundColour='--colour-text-primary'       hoverColour='--colour-text-secondary'       textColour='--colour-background-primary'       icon='settings'      >",
		ctx
	});
...
function create_default_slot$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(container0, file$1, 30, 1, 897);
			attr_dev(container1, "class", "customize svelte-1k3e064");
			add_location(container1, file$1, 40, 3, 1039);
			attr_dev(container2, "class", "submit svelte-1k3e064");
			add_location(container2, file$1, 52, 3, 1311);
			attr_dev(container3, "class", "buttons svelte-1k3e064");
			add_location(container3, file$1, 37, 2, 999);
			attr_dev(container4, "class", "content svelte-1k3e064");
			add_location(container4, file$1, 34, 1, 962);
		},
		m: function mount(target, anchor) {
...
function create_appBar_slot(ctx) {
	...
	let closableappbar;
	let current;
	closableappbar = new ClosableAppBar({ $$inline: true });
...
//# sourceMappingURL=CallRoute-38cb5f7f.js.map
