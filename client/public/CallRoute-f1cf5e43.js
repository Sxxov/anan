...
function create_fragment$2(ctx) {
	...
	image = new Image({
			props: {
				height: "min(50vmax, 400px)",
				width: "min(50vmax, 400px)",
				roundness: "100%",
	...
	const block = {
		c: function create() {
			...
			attr_dev(container, "class", "image svelte-8hi9ql");
			add_location(container, file$2, 17, 1, 1046);
		...
		m: function mount(target, anchor) {
			insert_dev(target, component, anchor);
			append_dev(component, container);
			mount_component(image, container, null);
			current = true;
		},
		p: function update(ctx, [dirty]) {
			const image_changes = {};
...
//# sourceMappingURL=CallRoute-f1cf5e43.js.map
