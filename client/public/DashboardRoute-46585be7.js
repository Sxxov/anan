...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = text(t_value);
			attr_dev(heading, "class", "svelte-11oz5qh");
			toggle_class(heading, "active", /*i*/ ctx[8] === activeIndex);
			add_location(heading, file$1, 56, 5, 1452);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(56:4) {#if $isTitlesEnabledW}",
		ctx
	});
...
// (48:3) <FillOrTwoToneButton      backgroundColour='transparent'      hoverColour='--colour-accent-secondary'      {icon}      isTwoTone={i !== activeIndex}      fillColour={i === activeIndex ? '--colour-accent-primary' : '--colour-text-secondary'}      iconSize='1.6rem'     >
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(48:3) <FillOrTwoToneButton      backgroundColour='transparent'      hoverColour='--colour-accent-secondary'      {icon}      isTwoTone={i !== activeIndex}      fillColour={i === activeIndex ? '--colour-accent-primary' : '--colour-text-secondary'}      iconSize='1.6rem'     >",
		ctx
	});
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = space();
			attr_dev(container, "class", "button svelte-11oz5qh");
			add_location(container, file$1, 44, 2, 1108);
		},
		m: function mount(target, anchor) {
			insert_dev(target, container, anchor);
...
function create_default_slot$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			each_1_anchor = empty();
			attr_dev(container, "class", "logo svelte-11oz5qh");
			add_location(container, file$1, 34, 1, 924);
		},
		m: function mount(target, anchor) {
			insert_dev(target, container, anchor);
...
//# sourceMappingURL=DashboardRoute-46585be7.js.map
